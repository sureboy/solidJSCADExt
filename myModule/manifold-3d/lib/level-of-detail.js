 ...
 */
export function setMinCircularAngle(angle) {
 ...
 */
export function setMinCircularEdgeLength(length) {
 ...
 */
export function setCircularSegments(segments) {
 ...
 */
export function getCircularSegments(radius) {
...
//# sourceMappingURL=level-of-detail.js.map