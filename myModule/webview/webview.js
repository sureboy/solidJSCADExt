...
`}}}const Pr=new Bp,ci=new ar,Dr=new ar,Q0=new jp(16777147,16777147,.6);Pr.add(Q0);const us=new zl(16777215,1);us.position.set(5,10,7);us.castShadow=!0;us.shadow.mapSize.width=2048;us.shadow.mapSize.height=2048;Dr.add(us);const ex=new $p(4210752,.3);Dr.add(ex);const Fh=new zl(16777215,.3);Fh.position.set(-5,5,-5);Dr.add(Fh);const Oh=new zl(16777215,.4);Oh.position.set(0,5,-10);Dr.add(Oh);const Bh=new Qp(20);Dr.add(Bh);Pr.background=null;let lt=new jt(40,1,.1,2e3),Wr,yi,Tr;Pr.add(ci);Pr.add(Dr);const zh=n=>new Ar().setFromObject(n).getSize(new D),hl=n=>{const e=zh(n);let t=e.length();return console.log(e,t),t||(t=hl(Bh)),t},tx=new J0,nx=()=>tx.parse(ci,{binary:!0});let Mi=15,ra=!1,kh=1;const ix={front:{position:new D(0,0,1),up:new D(0,1,0)},back:{position:new D(0,0,-1),up:new D(0,1,0)},left:{position:new D(-1,0,0),up:new D(0,1,0)},right:{position:new D(1,0,0),up:new D(0,1,0)},top:{position:new D(0,1,0),up:new D(0,0,-1)},bottom:{position:new D(0,-1,0),up:new D(0,0,1)}},rx={front:{position:new D(0,0,Mi),up:new D(0,1,0)},back:{position:new D(0,0,-Mi),up:new D(0,1,0)},left:{position:new D(-Mi,0,0),up:new D(0,1,0)},right:{position:new D(Mi,0,0),up:new D(0,1,0)},top:{position:new D(0,Mi,0),up:new D(0,0,-1)},bottom:{position:new D(0,-Mi,0),up:new D(0,0,1)}};function Hh(n){const t=(ra?rx:ix)[n];console.log(n,t),t&&(lt.position.copy(ra?t.position:sx(ci,t.position.clone())),lt.up.copy(t.up),lt.lookAt(0,0,0),yi.target.set(0,0,0),yi.update())}function sx(n,e){const t=new D(e[0]&1^1,e[1]&1^1,e[1]&1^1),r=zh(n).multiply(t).length(),s=kh*(Math.PI/180),a=r/2/Math.tan(s/2);return e.multiplyScalar(a)}function xa(n,e="Perspective"){if(Wr){if(e==="Orthographic"){ra=!0;const t=n.width/n.height,i=hl(ci)/2;lt&&lt.clear(),lt=new Bl(0,0,0,0,.1,2e3),lt.left=-i*t,lt.right=i*t,lt.top=i,lt.bottom=-i,lt.position.set(0,0,-i),Mi=i,fl(n)}else if(e==="Perspective"){ra=!1,lt&&lt.clear(),lt=new jt(40,1,.1,2e3);const t=hl(ci);kh=lt.fov;const i=lt.fov*(Math.PI/180);lt.position.z=t/2/Math.tan(i/2),lt.aspect=n.width/n.height,fl(n)}lt.updateProjectionMatrix(),Wr.setSize(n.width,n.height),Wr.render(Pr,lt),Hh("front")}}const du=()=>{requestAnimationFrame(()=>{Wr.render(Pr,lt)})},fl=n=>{yi?(yi.object=lt,yi.removeEventListener("change",du)):yi=new z0(lt,n),yi.addEventListener("change",du)},Vl=(n,e=!1)=>{Wr=new O0({antialias:!0,alpha:!0,canvas:n,preserveDrawingBuffer:!0}),fl(n)},ax=n=>{n!==Tr?(Tr=n,Vl(n)):ci.clear()},ox=new cl({color:30932,specular:1118481,shininess:200}),lx=(n,e)=>{n!==Tr&&(Tr=n,Vl(n)),ci.add(new mn(e,ox)),xa(n)},cx=(n,...e)=>{n!==Tr&&(Tr=n,Vl(n)),ci.add(...e)};let sa;const ux=n=>{n.el=_h(),n.el.width=document.body.clientWidth,n.el.height=document.body.clientHeight,sa.innerHTML="",sa.appendChild(n.el),window.addEventListener("resize",()=>{n.el.width=document.body.clientWidth,n.el.height=document.body.clientHeight,xa(n.el,n.workermsg.cameraType)})};var hx=At('<div style="position: absolute;left:0;top:0;z-index: 1;"></div>');function fx(n,e){qn(e,!1),th();var t=hx();zs(t,i=>sa=i,()=>sa),Mt(n,t),Yn()}var dx=At('<input type="text"/>'),px=At('<input type="number"/>'),mx=At('<input type="checkbox"/>'),_x=At("<label> <!></label>"),gx=At('<div style="padding-left:10px;"><!></div>'),vx=At('<details><summary style="cursor: pointer;height:48px;text-align: left;line-height: 48px;"> </summary>  <div style="color:white;text-align: left;" id="Options_list"></div> <!></details>');function Vh(n,e){qn(e,!0);const t=nh(e,"options");var i=vx(),r=Ot(i),s=Ot(r),a=nn(r,2);fd(a,21,()=>Object.keys(t()),ud,(c,l)=>{const u=po(()=>t()[Ge(l)]),h=po(()=>typeof Ge(u));var d=gx(),p=Ot(d);{var _=m=>{Vh(m,{get options(){return Ge(u)},get name(){return Ge(l)}})},g=m=>{var f=_x(),T=Ot(f),y=nn(T);{var M=w=>{var C=dx();ir(()=>Ta(C,"name",Ge(l))),sc(C,()=>t()[Ge(l)],U=>t()[Ge(l)]=U),Mt(w,C)},A=w=>{var C=ic(),U=_o(C);{var S=P=>{var O=px();ir(()=>Ta(O,"name",Ge(l))),sc(O,()=>t()[Ge(l)],V=>t()[Ge(l)]=V),Mt(P,O)},E=P=>{var O=ic(),V=_o(O);{var W=q=>{var H=mx();ir(()=>Ta(H,"name",Ge(l))),xd(H,()=>t()[Ge(l)],J=>t()[Ge(l)]=J),Mt(q,H)};dn(V,q=>{Ge(h)==="boolean"&&q(W)},!0)}Mt(P,O)};dn(U,P=>{Ge(h)==="number"?P(S):P(E,!1)},!0)}Mt(w,C)};dn(y,w=>{Ge(h)==="string"?w(M):w(A,!1)})}ir(()=>$s(T,`${Ge(l)??""} `)),Mt(m,f)};dn(p,m=>{Ge(h)==="object"?m(_):m(g,!1)})}Mt(c,d)});var o=nn(a,2);pd(o,()=>e.children),ir(()=>$s(s,e.name)),Mt(n,i),Yn()}const Pi=new Map,Xr=new Map,pu=window.includeImport,Gh=(n,e,t)=>{let i;for(;(i=e.exec(n))!==null;)t(i,e.lastIndex)},xx=n=>{const e=/import\s*(?:(?:(?:\w+|\*\s*as\s*\w+|\{[^}]*\})\s+from\s+)?['"]([^'"]+)['"]|['"]([^'"]+)['"])/g,t=[];return Gh(n,e,(i,r)=>{const s=i[1]||i[2],a=Math.max(i[0].indexOf("'"),i[0].indexOf('"')),o=i.index+a+1;t.push({moduleName:s,startPosition:o,endPosition:o+s.length})}),t},Qr=async(n,e,t=new Set)=>{let i="";if(t.add(n),!!n.srcList){for(const r of n.srcList){if(typeof r=="string"){i+=r;continue}const s=await r();s.db&&(t.has(s)||await Qr(s,e,t)),i+=s.name}i&&e(n.name,i)}},Ni=(n,e)=>new Promise((t,i)=>{if(n.startsWith("./")||pu[n]&&(n=pu[n]),Pi.has(n)){t(Pi.get(n));return}if(!e){console.log("not reqmsg",n),t(dl({name:n}));return}e({type:"req",path:n});const r=setTimeout(()=>{Xr.delete(n),t(dl({name:n}))},2e3);Xr.set(n,s=>{clearTimeout(r),t(s),Xr.delete(n)})}),Mx=new TextDecoder,Wh=n=>{n.url&&(URL.revokeObjectURL(n.url),n.url="",n.persons.forEach(e=>{Wh(e)}))},Sx=(n,e,t)=>{if(Wh(n),n.srcList=[],!e.db)return;let i="";if(typeof e.db=="string")i=e.db;else if(e.db instanceof ArrayBuffer)i=Mx.decode(e.db);else{console.log(e,typeof e.db);return}let r=0;xx(i).forEach(s=>{n.srcList.push(i.slice(r,s.startPosition)),n.srcList.push(()=>Ni(s.moduleName,t)),r=s.endPosition}),n.srcList.push(i.slice(r))},Ex=async n=>{if(n.url)return n.url;if(!n.srcList)return new URL(n.name,new URL(import.meta.url).origin).toString();let e="";for(const t of n.srcList)if(typeof t=="string")e+=t;else{const i=await t();e+=await i.getUri(),typeof i!="string"&&i.persons&&i.persons.add(n)}return e?(n.url=URL.createObjectURL(new Blob([e],{type:"application/javascript"})),n.url):new URL(n.name,new URL(import.meta.url).origin).toString()},dl=n=>{const e={persons:new Set,getUri:async()=>Ex(e),...n};return e},yx=n=>{Pi.delete(n)},Tx=()=>{Pi.clear()},Xh=(n,e)=>{if(!n.name)return;let t;Pi.has(n.name)?t=Pi.get(n.name):(t=dl(n),Pi.set(n.name,t)),Sx(t,n,e),Xr.has(n.name)&&Xr.get(n.name)(t)};var bx=At('<button style="height:48:px;line-height:48px;cursor: pointer;">STL</button>'),wx=At('<button style="height:48:px;line-height:48px;cursor: pointer;">Gzip</button>'),Ax=At('<button style="height:48:px;line-height:48px;cursor: pointer;">Src</button>'),Rx=At('<details><summary style="cursor:pointer;height:48px;text-align:left;line-height: 48px;">Download</summary> <div><!> <!> <!></div></details>');function Cx(n,e){qn(e,!0);const t=()=>{console.log("down src"),e.workermsg.postMessage({type:"downSrc"})},i=()=>{const _=nx(),g=new Blob([_.buffer],{type:"application/octet-stream"}),m=document.createElement("a");m.href=URL.createObjectURL(g),m.download=`${e.workermsg.func}_${e.workermsg.in.split(".").shift()}_${e.workermsg.name}_${Date.now()}.stl`,m.click(),URL.revokeObjectURL(m.href)},r=async()=>{if(!window.CompressionStream||!window.DecompressionStream){console.log("down code err");return}let _=e.workermsg.in;_.startsWith("./")||(_="./"+_);const g=await Ni("./lib/csgChange.js"),m=await Ni(_);let f="";await Qr(g,(A,w)=>{f+=`
/**${A}*/
${w}
`}),await Qr(m,(A,w)=>{f+=`
/**${A}*/
${w}
`});const T=await s(f),y=new Blob(T,{type:"application/gzip"}),M=document.createElement("a");M.href=URL.createObjectURL(y),M.download=`${e.workermsg.func}_${e.workermsg.in.split(".").shift()}_${e.workermsg.name}_${Date.now()}.solidjscad.gz`,M.click(),URL.revokeObjectURL(M.href)},s=async _=>{const g=new TextEncoder().encode(_),m=new ReadableStream({start(A){A.enqueue(g),A.close()}}),f=new CompressionStream("gzip"),y=m.pipeThrough(f).getReader(),M=[];for(;;){const{done:A,value:w}=await y.read();if(A)break;M.push(w)}return M};var a=Rx(),o=nn(Ot(a),2),c=Ot(o);{var l=_=>{var g=bx();g.__click=i,Mt(_,g)};dn(c,_=>{e.workermsg.showMenu&4&&_(l)})}var u=nn(c,2);{var h=_=>{var g=wx();g.__click=r,Mt(_,g)};dn(u,_=>{e.workermsg.showMenu&8&&_(h)})}var d=nn(u,2);{var p=_=>{var g=Ax();g.__click=t,Mt(_,g)};dn(d,_=>{e.workermsg.showMenu&16&&_(p)})}Mt(n,a),Yn()}pa(["click"]);let aa,pl,qs;const Px=n=>{aa.innerHTML="",qs.textContent=n.basename,n.list.forEach(e=>{const t=pl.cloneNode(!0);t.textContent=e,aa.appendChild(t)})};var Dx=At('<details><summary style="cursor: pointer;height:48px;text-align: left;line-height: 48px;">...</summary>  <div style="color:white;text-align: center;" id="module_list"><button style="height:48:px;line-height:48px;cursor: pointer;">...</button></div></details>');function Lx(n,e){qn(e,!0);var t=Dx(),i=Ot(t);zs(i,a=>qs=a,()=>qs);var r=nn(i,2);r.__click=a=>{const o=a.target.closest("button");o.textContent!=="..."&&(qs.textContent=o.textContent,e.Clickhandle(o.textContent))};var s=Ot(r);zs(s,a=>pl=a,()=>pl),zs(r,a=>aa=a,()=>aa),Mt(n,t),Yn()}pa(["click"]);let lr=!0,cr=bi(["Perspective [ V ]",""]),qh=Fn("[ U ]");function Yh(){cr[0]=lr?"Perspective [ V ]":"Orthographic [ U ]",cr[1]="[ Z ]"}function Ux(){return lr=!lr,Mn(qh,lr?"[ U ]":"[ V ]",!0),lr?"Perspective":"Orthographic"}var Ix=At('<details><summary style="cursor:pointer;height:48px;text-align:left;line-height: 48px;"> </summary>  <div style="color:white;"><button id="camera" title="camera" style="height:48:px;line-height:48px;cursor: pointer;"> </button> <button id="front" title="front" style="height:48:px;line-height:48px;cursor: pointer;">[ Z ]</button> <button id="back" title="back" style="height:48:px;line-height:48px;cursor: pointer;">[ z ]</button> <button id="top" title="top" style="height:48:px;line-height:48px;cursor: pointer;">[ Y ]</button> <button id="bottom" title="bottom" style="height:48:px;line-height:48px;cursor: pointer;">[ y ]</button> <button id="left" title="left" style="height:48:px;line-height:48px;cursor: pointer;">[ X ]</button> <button id="right" title="right" style="height:48:px;line-height:48px;cursor: pointer;">[ x ]</button> <button id="refresh" title="refresh" style="height:48:px;line-height:48px;cursor: pointer;">[ r ]</button></div> <div><p>Right-click and drag, or use two-finger touch and drag</p></div></details>');function Nx(n,e){qn(e,!0);const t={x:"right",X:"left",y:"bottom",Y:"top",z:"back",Z:"front",U:"camera",V:"camera",r:"refresh"},i=u=>{if(u.target.tagName==="INPUT"||u.target.tagName==="TEXTAREA")return;const h=t[u.key];h&&e.Clickhandle(h)};var r=Ix();sd("keydown",mo,i);var s=Ot(r),a=Ot(s),o=nn(s,2);o.__click=u=>{const h=u.target.closest("button");h.id&&(e.Clickhandle(h.id),h.id!=="camera"?cr[1]=h.textContent:(cr[0]=(lr?"Perspective":"Orthographic")+" "+h.textContent,cr[1]="[ Z ]"))};var c=Ot(o),l=Ot(c);ir(u=>{$s(a,u),$s(l,Ge(qh))},[()=>cr.join(" ")]),Mt(n,r),Yn()}pa(["click"]);const mu=!1,es={mesh:{def:new cl({color:34001,flatShading:mu}),make:n=>new cl({...n,flatShading:mu})},line:{def:new ta({color:255}),make:n=>new ta(n)},lines:null};es.lines=es.line;es.instance=es.mesh;function Fx(n,{smooth:e=!1}){const{vertices:t,indices:i,normals:r,color:s,colors:a,isTransparent:o=!1,opacity:c}=n;let{transforms:l}=n;const u=n.type||"mesh",h=es[u];if(!h){console.error(`material not found for type ${u}`,n);return}let d=h.def;if(s||a){const g=s||a,m={vertexColors:!!a,opacity:g[3]===void 0?1:g[3],transparent:s&&g[3]!==1&&g[3]!==void 0||o};c&&(m.opacity=c),a||(m.color=new ze(s[0],s[1],s[2])),d=h.make(m),c&&(d.transparent=!0,d.opacity=c)}let p=new sn;p.setAttribute("position",new St(t,3)),i&&p.setIndex(new St(i,1)),r&&p.setAttribute("normal",new St(r,3)),e&&(p=Ox(p,Math.PI/10)),a&&p.setAttribute("color",new St(a,o?4:3));let _;switch(u){case"mesh":_=new mn(p,d);break;case"line":_=new wh(p,d);break;case"lines":_=new Ah(p,d);break}return l&&_.applyMatrix4({elements:l}),_}function Ox(n,e=Math.PI/3){const t=Math.cos(e),i=(1+1e-10)*100,r=[new D,new D,new D],s=new D,a=new D,o=new D,c=new D;function l(g){const m=~~(g.x*i),f=~~(g.y*i),T=~~(g.z*i);return`${m},${f},${T}`}const u=n.index?n.toNonIndexed():n,h=u.attributes.position,d={};for(let g=0,m=h.count/3;g<m;g++){const f=3*g,T=r[0].fromBufferAttribute(h,f+0),y=r[1].fromBufferAttribute(h,f+1),M=r[2].fromBufferAttribute(h,f+2);s.subVectors(M,y),a.subVectors(T,y);const A=new D().crossVectors(s,a).normalize();for(let w=0;w<3;w++){const C=r[w],U=l(C);U in d||(d[U]=[]),d[U].push(A)}}const p=new Float32Array(h.count*3),_=new St(p,3,!1);for(let g=0,m=h.count/3;g<m;g++){const f=3*g,T=r[0].fromBufferAttribute(h,f+0),y=r[1].fromBufferAttribute(h,f+1),M=r[2].fromBufferAttribute(h,f+2);s.subVectors(M,y),a.subVectors(T,y),o.crossVectors(s,a).normalize();for(let A=0;A<3;A++){const w=r[A],C=l(w),U=d[C];c.set(0,0,0);for(let S=0,E=U.length;S<E;S++){const P=U[S];o.dot(P)>t&&c.add(P)}c.normalize(),_.setXYZ(f+A,c.x,c.y,c.z)}}return u.setAttribute("normal",_),u}const Bx=`
...
};`,kx=async(n,e)=>{const i=await(await Ni("./lib/csgChange.js",e)).getUri();let r=n.in;if(r.startsWith("./")||(r="./"+r),r.endsWith(".js")||(r+=".js"),n.src){const c=r.split("/");r=[c[0],n.src,...c.slice(1)].join("/")}const a=await(await Ni(r,e)).getUri(),o=`
  ${Bx} 
