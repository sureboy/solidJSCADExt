...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function xc(){return new ni({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ml(),fragmentShader:`
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function Mc(){return new ni({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ml(),fragmentShader:`
...
#define LOW_PRECISION`),t}function mv(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===wu?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Of?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===wn&&(t="SHADOWMAP_TYPE_VSM"),t}function _v(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case ur:case hr:t="ENVMAP_TYPE_CUBE";break;case ta:t="ENVMAP_TYPE_CUBE_UV";break}return t}function gv(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case hr:t="ENVMAP_MODE_REFRACTION";break}return t}function vv(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case el:t="ENVMAP_BLENDING_MULTIPLY";break;case nd:t="ENVMAP_BLENDING_MIX";break;case id:t="ENVMAP_BLENDING_ADD";break}return t}function xv(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function Mv(n,t,e,i){const r=n.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=mv(e),l=_v(e),u=gv(e),f=vv(e),d=xv(e),p=ov(e),_=lv(s),v=r.createProgram();let m,h,y=e.glslVersion?"#version "+e.glslVersion+`
...
`}}}const xr=new Kd,Ti=new Qi,Mr=new Qi,u0=new sp(16777147,16777147,.6);xr.add(u0);const Zr=new pl(16777215,1);Zr.position.set(5,10,7);Zr.castShadow=!0;Zr.shadow.mapSize.width=2048;Zr.shadow.mapSize.height=2048;Mr.add(Zr);const h0=new lp(4210752,.3);Mr.add(h0);const ah=new pl(16777215,.3);ah.position.set(-5,5,-5);Mr.add(ah);const oh=new pl(16777215,.4);oh.position.set(0,5,-10);Mr.add(oh);const lh=new up(20);Mr.add(lh);xr.background=null;const ch=new je(40,1,.1,2e3),f0=new dl(0,0,0,0,.1,2e3);let we=ch,Lr,Rr,pr;xr.add(Ti);xr.add(Mr);const Ho=n=>{let i=new _r().setFromObject(n).getSize(new I).length();return i||(i=Ho(lh)),i},d0=new c0,p0=()=>d0.parse(Ti,{binary:!0});function ra(n,t="Perspective"){if(Lr){if(t==="Orthographic"){const e=n.width/n.height,i=Ho(Ti)/2;we=f0,we.left=-i*e,we.right=i*e,we.top=i,we.bottom=-i,we.position.set(0,0,i),Vo(n)}else if(t==="Perspective"){we=ch;const e=Ho(Ti),i=we.fov*(Math.PI/180);we.position.z=e/2/Math.tan(i/2),we.aspect=n.width/n.height,Vo(n)}we.updateProjectionMatrix(),Lr.setSize(n.width,n.height),Lr.render(xr,we)}}const kc=()=>{requestAnimationFrame(()=>{Lr.render(xr,we)})},Vo=n=>{Rr?(Rr.object=we,Rr.removeEventListener("change",kc)):Rr=new Zv(we,n),Rr.addEventListener("change",kc)},gl=(n,t=!1)=>{Lr=new jv({antialias:!0,alpha:!0,canvas:n,preserveDrawingBuffer:!0}),Vo(n)},m0=n=>{n!==pr?(pr=n,gl(n)):Ti.clear()},_0=new zo({color:30932,specular:1118481,shininess:200}),g0=(n,t)=>{n!==pr&&(pr=n,gl(n)),Ti.add(new un(t,_0)),ra(n)},v0=(n,...t)=>{n!==pr&&(pr=n,gl(n)),Ti.add(...t)};let Go,Wo,Xo,Ki=!0;function x0(){return Ki=!Ki,Go.setAttribute("opacity",Ki?"1":"0.5"),Wo.setAttribute("opacity",Ki?"0.5":"1"),Xo.setAttribute("x",Ki?"12":"24"),Ki?"Perspective":"Orthographic"}var M0=bf('<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="1" width="46" height="46" rx="4" fill="#2d2d2d" stroke="#555" stroke-width="1"></rect><g id="perspective-icon" transform="translate(8, 8) scale(0.8)"><path d="M6 6 L26 6 L36 26 L16 26 Z" fill="none" stroke="#4fc3f7" stroke-width="2" stroke-linejoin="round"></path><path d="M6 6 L16 26" stroke="#4fc3f7" stroke-width="2"></path><path d="M26 6 L36 26" stroke="#4fc3f7" stroke-width="2"></path><circle cx="21" cy="1" r="3" fill="#4fc3f7"></circle><line x1="21" y1="4" x2="21" y2="6" stroke="#4fc3f7" stroke-width="2"></line></g><g id="orthographic-icon" transform="translate(8, 8) scale(0.8)" opacity="0.5"><rect x="6" y="6" width="30" height="20" fill="none" stroke="#81c784" stroke-width="2" stroke-linejoin="round"></rect><line x1="6" y1="6" x2="1" y2="1" stroke="#81c784" stroke-width="2"></line><line x1="36" y1="6" x2="41" y2="1" stroke="#81c784" stroke-width="2"></line><line x1="36" y1="26" x2="41" y2="31" stroke="#81c784" stroke-width="2"></line><line x1="6" y1="26" x2="1" y2="31" stroke="#81c784" stroke-width="2"></line></g><rect x="12" y="36" width="24" height="4" rx="2" fill="#555"></rect><rect id="toggle-indicator" x="12" y="36" width="12" height="4" rx="2" fill="#4fc3f7"></rect></svg>');function S0(n){var t=M0(),e=Un(on(t));xi(e,s=>Go=s,()=>Go);var i=Un(e);xi(i,s=>Wo=s,()=>Wo);var r=Un(i,2);xi(r,s=>Xo=s,()=>Xo),qr(n,t)}const ar=new Map,Ur=new Map,Hc=window.includeImport,uh=(n,t,e)=>{let i;for(;(i=t.exec(n))!==null;)e(i,t.lastIndex)},E0=n=>{const t=/import\s*(?:(?:(?:\w+|\*\s*as\s*\w+|\{[^}]*\})\s+from\s+)?['"]([^'"]+)['"]|['"]([^'"]+)['"])/g,e=[];return uh(n,t,(i,r)=>{const s=i[1]||i[2],a=Math.max(i[0].indexOf("'"),i[0].indexOf('"')),o=i.index+a+1;e.push({moduleName:s,startPosition:o,endPosition:o+s.length})}),e},Vr=async(n,t,e=new Set)=>{let i="";if(e.add(n),!!n.srcList){for(const r of n.srcList){if(typeof r=="string"){i+=r;continue}const s=await r();s.db&&(e.has(s)||await Vr(s,t,e)),i+=s.name}i&&t(n.name,i)}},bi=(n,t)=>new Promise((e,i)=>{if(n.startsWith("./")||Hc[n]&&(n=Hc[n]),ar.has(n)){e(ar.get(n));return}if(!t){console.log("not reqmsg",n),e(qo({name:n}));return}t({type:"req",path:n});const r=setTimeout(()=>{Ur.delete(n),e(qo({name:n}))},2e3);Ur.set(n,s=>{clearTimeout(r),e(s),Ur.delete(n)})}),y0=new TextDecoder,hh=n=>{n.url&&(URL.revokeObjectURL(n.url),n.url="",n.persons.forEach(t=>{hh(t)}))},T0=(n,t,e)=>{if(hh(n),n.srcList=[],!t.db)return;let i="";if(typeof t.db=="string")i=t.db;else if(t.db instanceof ArrayBuffer)i=y0.decode(t.db);else{console.log(t,typeof t.db);return}let r=0;E0(i).forEach(s=>{n.srcList.push(i.slice(r,s.startPosition)),n.srcList.push(()=>bi(s.moduleName,e)),r=s.endPosition}),n.srcList.push(i.slice(r))},b0=async n=>{if(n.url)return n.url;if(!n.srcList)return n.name;let t="";for(const e of n.srcList)if(typeof e=="string")t+=e;else{const i=await e();t+=await i.getUri(),typeof i!="string"&&i.persons&&i.persons.add(n)}return t?(n.url=URL.createObjectURL(new Blob([t],{type:"application/javascript"})),n.url):n.name},qo=n=>{const t={persons:new Set,getUri:async()=>b0(t),...n};return t},A0=n=>{ar.delete(n)},fh=(n,t)=>{if(!n.name)return;let e;ar.has(n.name)?e=ar.get(n.name):(e=qo(n),ar.set(n.name,e)),T0(e,n,t),Ur.has(n.name)&&Ur.get(n.name)(e)};var w0=Qs('<details name="downMenu"><summary class="download-summary svelte-17o52b0"><svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M24 32L24 16M24 32L18 26M24 32L30 26" stroke="#3498db" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10 38H38" stroke="#3498db" stroke-width="3" stroke-linecap="round"></path></svg></summary>  <div class="download-options svelte-17o52b0"><div class="download-option svelte-17o52b0"><div class="option-text svelte-17o52b0">STL</div></div> <div class="download-option svelte-17o52b0"><div class="option-text svelte-17o52b0">Gzip</div></div></div></details>');function R0(n,t){Ri(t,!1);let e=lr(t,"workermsg",8);const i=()=>{const d=p0(),p=new Blob([d.buffer],{type:"application/octet-stream"}),_=document.createElement("a");_.href=URL.createObjectURL(p),_.download=`${e().name}_${e().main}_${e().index.split(".").shift()}_${Date.now()}.stl`,_.click(),URL.revokeObjectURL(_.href)},r=async()=>{if(!window.CompressionStream||!window.DecompressionStream){console.log("down code err");return}let d=e().index;d.startsWith("./")||(d="./"+d);const p=await bi("./lib/csgChange.js"),_=await bi(d);let v="";await Vr(p,(b,E)=>{v+=`
/**${b}*/
${E}
`}),await Vr(_,(b,E)=>{v+=`
/**${b}*/
${E}
`});const m=await s(v),h=new Blob(m,{type:"application/gzip"}),y=document.createElement("a");y.href=URL.createObjectURL(h),y.download=`${e().name}_${e().main}_${e().index.split(".").shift()}_${Date.now()}.mgtoy.gz`,y.click(),URL.revokeObjectURL(y.href)},s=async d=>{const p=new TextEncoder().encode(d),_=new ReadableStream({start(b){b.enqueue(p),b.close()}}),v=new CompressionStream("gzip"),h=_.pipeThrough(v).getReader(),y=[];for(;;){const{done:b,value:E}=await h.read();if(b)break;y.push(E)}return y};mr();var a=w0(),o=Un(on(a),2),c=on(o),l=on(c);l.__click=i;var u=Un(c,2),f=on(u);f.__click=r,qr(n,a),Ci()}Qo(["click"]);let Ir,Ws,Nr;const C0=n=>{Ir.innerHTML="",Nr.textContent=n.basename,console.log("change Main name",Nr),n.list.forEach(t=>{const e=Ws.cloneNode(!0);e.textContent=t,Ir.appendChild(e)}),Ir.appendChild(Ws)};var P0=n=>{console.log(n)},D0=Qs('<details name="moduleMenu"><summary style="cursor: pointer;height:48px;text-align: center;line-height: 48px;">...</summary>  <div style="color:white;text-align: center;" id="module_list"><button class="option-text" style="height:48:px;line-height:48px;cursor: pointer;">...</button></div></details>');function L0(n,t){Ri(t,!1);let e=lr(t,"Clickhandle",8);mr();var i=D0(),r=on(i);xi(r,o=>Nr=o,()=>Nr);var s=Un(r,2);s.__click=o=>{const c=o.target.closest("button");console.log(c.textContent),c.textContent!=="..."&&(Nr.textContent="...",e()(c.textContent))};var a=on(s);a.__click=[P0],xi(a,o=>Ws=o,()=>Ws),xi(s,o=>Ir=o,()=>Ir),qr(n,i),Ci()}Qo(["click"]);const jn={...window.myConfig,cameraType:"Perspective",module:n=>{C0(n)}};var U0=Qs('<div id="downMenuList"><div style="position: absolute;right:5px;top:5px;z-index: 11;cursor: pointer;" class="pointer-events-auto "><!></div> <div style="position:absolute;left:0px;top:5px;z-index:10;width:100%;font-weight: 500;" class="pointer-events-auto"><!></div></div>');function I0(n,t){Ri(t,!1);let e=lr(t,"Clickhandle",8);mr();var i=U0(),r=on(i),s=on(r);R0(s,{get workermsg(){return jn}});var a=Un(r,2),o=on(a);L0(o,{get Clickhandle(){return e()}}),qr(n,i),Ci()}const Vc=!1,Gr={mesh:{def:new zo({color:34001,flatShading:Vc}),make:n=>new zo({...n,flatShading:Vc})},line:{def:new Hs({color:255}),make:n=>new Hs(n)},lines:null};Gr.lines=Gr.line;Gr.instance=Gr.mesh;function N0(n,{smooth:t=!1}){const{vertices:e,indices:i,normals:r,color:s,colors:a,isTransparent:o=!1,opacity:c}=n;let{transforms:l}=n;const u=n.type||"mesh",f=Gr[u];if(!f){console.error(`material not found for type ${u}`,n);return}let d=f.def;if(s||a){const v=s||a,m={vertexColors:!!a,opacity:v[3]===void 0?1:v[3],transparent:s&&v[3]!==1&&v[3]!==void 0||o};c&&(m.opacity=c),a||(m.color=new zt(s[0],s[1],s[2])),d=f.make(m),c&&(d.transparent=!0,d.opacity=c)}let p=new Qe;p.setAttribute("position",new _e(e,3)),i&&p.setIndex(new _e(i,1)),r&&p.setAttribute("normal",new _e(r,3)),t&&(p=F0(p,Math.PI/10)),a&&p.setAttribute("color",new _e(a,o?4:3));let _;switch(u){case"mesh":_=new un(p,d);break;case"line":_=new Zu(p,d);break;case"lines":_=new $u(p,d);break}return l&&_.applyMatrix4({elements:l}),_}function F0(n,t=Math.PI/3){const e=Math.cos(t),i=(1+1e-10)*100,r=[new I,new I,new I],s=new I,a=new I,o=new I,c=new I;function l(v){const m=~~(v.x*i),h=~~(v.y*i),y=~~(v.z*i);return`${m},${h},${y}`}const u=n.index?n.toNonIndexed():n,f=u.attributes.position,d={};for(let v=0,m=f.count/3;v<m;v++){const h=3*v,y=r[0].fromBufferAttribute(f,h+0),b=r[1].fromBufferAttribute(f,h+1),E=r[2].fromBufferAttribute(f,h+2);s.subVectors(E,b),a.subVectors(y,b);const C=new I().crossVectors(s,a).normalize();for(let w=0;w<3;w++){const R=r[w],L=l(R);L in d||(d[L]=[]),d[L].push(C)}}const p=new Float32Array(f.count*3),_=new _e(p,3,!1);for(let v=0,m=f.count/3;v<m;v++){const h=3*v,y=r[0].fromBufferAttribute(f,h+0),b=r[1].fromBufferAttribute(f,h+1),E=r[2].fromBufferAttribute(f,h+2);s.subVectors(E,b),a.subVectors(y,b),o.crossVectors(s,a).normalize();for(let C=0;C<3;C++){const w=r[C],R=l(w),L=d[R];c.set(0,0,0);for(let S=0,M=L.length;S<M;S++){const P=L[S];o.dot(P)>e&&c.add(P)}c.normalize(),_.setXYZ(h+C,c.x,c.y,c.z)}}return u.setAttribute("normal",_),u}const O0=`
...
};`;let An;const z0=async(n,t)=>{const i=await(await bi("./lib/csgChange.js",t)).getUri();let r=n.index;r.startsWith("./")||(r="./"+r);const a=await(await bi(r,t)).getUri(),o=`import * as csg  from '${i}'
...
${B0} `;return console.log(o),URL.createObjectURL(new Blob([o],{type:"application/javascript"}))},vl=(n,t,e)=>{An&&(An.terminate(),An=null),e({type:"start"}),z0(t,e).then(i=>{An=new Worker(i,{type:"module"}),An.onerror=r=>{console.error("error",r),e({type:"error",msg:"Code syntax error"})},An.onmessageerror=r=>{console.error("messageErr",r),e({type:"error",msg:r.data})},An.onmessage=function(r){const s=r.data;if(console.log(r,s),s.start)try{m0(n)}catch(a){e({type:"initError",msg:a.error})}s.ver&&v0(n,N0(s.ver,{})),s.end&&(s.module&&t.module(s.module),console.log("cameraType",t.cameraType),ra(n,t.cameraType),An?.terminate(),URL.revokeObjectURL(i),An=null,e({type:"end"})),s.log&&e({type:"log",msg:s.log}),s.error&&e({type:"error",msg:s.error})}})};let Xs;const ve={workermsg:jn},k0=()=>{ve.el=ku(),ve.el.width=document.body.clientWidth,ve.el.height=document.body.clientHeight,Xs.innerHTML="",Xs.appendChild(ve.el),window.addEventListener("resize",()=>{ve.el.width=document.body.clientWidth,ve.el.height=document.body.clientHeight,ra(ve.el,jn.cameraType)})};var H0=Qs('<div style="position: absolute;left:0;top:0;z-index: 1;"></div>  <div style="position: absolute;left:5px;top:5px;z-index: 11;cursor: pointer;" class="pointer-events-auto" id="camera-toggle"><!></div> <!>',1);function V0(n,t){Ri(t,!1);let e=lr(t,"postMessage",8),i=lr(t,"showMenu",8,!0);mr();var r=H0(),s=af(r);xi(s,u=>Xs=u,()=>Xs);var a=Un(s,2);a.__click=()=>{jn.cameraType=x0(),console.log(jn),ra(ve.el,jn.cameraType)};var o=on(a);S0(o);var c=Un(a,2);{var l=u=>{I0(u,{Clickhandle:f=>{jn.main=f,vl(ve.el,jn,e())}})};Pf(c,u=>{i()&&u(l)})}qr(n,r),Ci()}Qo(["click"]);const G0=async n=>{const t=new DecompressionStream("gzip"),e=t.writable.getWriter();e.write(n),e.close();const r=await new Response(t.readable).arrayBuffer();let s="";try{s=new TextDecoder().decode(r)}catch(a){console.error(a)}return s},W0=(n,t)=>{let e="",i=0;uh(n,/\/\*\*\s*([\w\.\/]+)\s*\*/g,(r,s)=>{e&&t({name:e,db:n.slice(i,r.index).trim()}),e=r[1],i=s+1}),e&&t({name:e,db:n.slice(i).trim()})};class X0 extends hl{constructor(t){super(t)}load(t,e,i,r){const s=this,a=new rp(this.manager);a.setPath(this.path),a.setResponseType("arraybuffer"),a.setRequestHeader(this.requestHeader),a.setWithCredentials(this.withCredentials),a.load(t,function(o){try{e(s.parse(o))}catch(c){r?r(c):console.error(c),s.manager.itemError(t)}},i,r)}parse(t){function e(l){const u=new DataView(l),f=32/8*3+32/8*3*3+16/8,d=u.getUint32(80,!0);if(80+32/8+d*f===u.byteLength)return!0;const _=[115,111,108,105,100];for(let v=0;v<5;v++)if(i(_,u,v))return!1;return!0}function i(l,u,f){for(let d=0,p=l.length;d<p;d++)if(l[d]!==u.getUint8(f+d))return!1;return!0}function r(l){const u=new DataView(l),f=u.getUint32(80,!0);let d,p,_,v=!1,m,h,y,b,E;for(let P=0;P<70;P++)u.getUint32(P,!1)==1129270351&&u.getUint8(P+4)==82&&u.getUint8(P+5)==61&&(v=!0,m=new Float32Array(f*3*3),h=u.getUint8(P+6)/255,y=u.getUint8(P+7)/255,b=u.getUint8(P+8)/255,E=u.getUint8(P+9)/255);const C=84,w=50,R=new Qe,L=new Float32Array(f*3*3),S=new Float32Array(f*3*3),M=new zt;for(let P=0;P<f;P++){const O=C+P*w,H=u.getFloat32(O,!0),j=u.getFloat32(O+4,!0),X=u.getFloat32(O+8,!0);if(v){const G=u.getUint16(O+48,!0);(G&32768)===0?(d=(G&31)/31,p=(G>>5&31)/31,_=(G>>10&31)/31):(d=h,p=y,_=b)}for(let G=1;G<=3;G++){const K=O+G*12,k=P*3*3+(G-1)*3;L[k]=u.getFloat32(K,!0),L[k+1]=u.getFloat32(K+4,!0),L[k+2]=u.getFloat32(K+8,!0),S[k]=H,S[k+1]=j,S[k+2]=X,v&&(M.setRGB(d,p,_,Ve),m[k]=M.r,m[k+1]=M.g,m[k+2]=M.b)}}return R.setAttribute("position",new _e(L,3)),R.setAttribute("normal",new _e(S,3)),v&&(R.setAttribute("color",new _e(m,3)),R.hasColors=!0,R.alpha=E),R}function s(l){const u=new Qe,f=/solid([\s\S]*?)endsolid/g,d=/facet([\s\S]*?)endfacet/g,p=/solid\s(.+)/;let _=0;const v=/[\s]+([+-]?(?:\d*)(?:\.\d*)?(?:[eE][+-]?\d+)?)/.source,m=new RegExp("vertex"+v+v+v,"g"),h=new RegExp("normal"+v+v+v,"g"),y=[],b=[],E=[],C=new I;let w,R=0,L=0,S=0;for(;(w=f.exec(l))!==null;){L=S;const M=w[0],P=(w=p.exec(M))!==null?w[1]:"";for(E.push(P);(w=d.exec(M))!==null;){let j=0,X=0;const G=w[0];for(;(w=h.exec(G))!==null;)C.x=parseFloat(w[1]),C.y=parseFloat(w[2]),C.z=parseFloat(w[3]),X++;for(;(w=m.exec(G))!==null;)y.push(parseFloat(w[1]),parseFloat(w[2]),parseFloat(w[3])),b.push(C.x,C.y,C.z),j++,S++;X!==1&&console.error("THREE.STLLoader: Something isn't right with the normal of face number "+_),j!==3&&console.error("THREE.STLLoader: Something isn't right with the vertices of face number "+_),_++}const O=L,H=S-L;u.userData.groupNames=E,u.addGroup(O,H,R),R++}return u.setAttribute("position",new Ge(y,3)),u.setAttribute("normal",new Ge(b,3)),u}function a(l){return typeof l!="string"?new TextDecoder().decode(l):l}function o(l){if(typeof l=="string"){const u=new Uint8Array(l.length);for(let f=0;f<l.length;f++)u[f]=l.charCodeAt(f)&255;return u.buffer||u}else return l}const c=o(t);return e(c)?r(c):s(a(t))}}let dh=!0;const q0={name:"del",fn:n=>{A0(n.name)}},Y0={name:"init",fn:(n,t)=>{fh(n,t)}},j0={fn:(n,t)=>{vl(ve.el,Object.assign({},ve.workermsg,{cameraType:n.open?ve.workermsg.cameraType:""}),t)},name:"run"},K0={fn:(n,t)=>{let e=ve.workermsg.index;e.startsWith("./")||(e="./"+e),bi(e,t).then(i=>{console.log(i),Vr(i,(r,s)=>{t({type:"src",name:r,code:s})}).then(()=>{bi("./lib/csgChange.js",t).then(r=>{Vr(r,(s,a)=>{t({type:"src",name:s,code:a})}).then(()=>{t({type:"src"})})})})})},name:"getSrc"},Z0={fn:(n,t)=>{G0(n.db).then(e=>{W0(e,i=>{fh(i),console.log(i.name)}),console.log(ve),vl(ve.el,ve.workermsg,t)})},name:"gzData"},$0={fn:n=>{g0(ve.el,new X0().parse(n.db)),dh=!1},name:"stlData"},Yo=[q0,j0,Y0,K0,Z0,$0],J0=n=>{function*t(){for(let e=0;e<Yo.length;e++)(n&1<<e)!==0&&(yield Yo[e])}return t()},Gc=(n,t)=>{console.log("messagepost",n);for(const e of J0(n.type))e.fn(n.msg,t)};function Q0(n,t){Ri(t,!1);let e=lr(t,"postMessage",8);mr(),V0(n,{get postMessage(){return e()},get showMenu(){return dh}}),Ci()}function tx(n,t){Ri(t,!1);let e,i=!1;const r=s=>{if(!i){console.log("not open",s);return}e.send(JSON.stringify(s))};Lf(()=>{console.log(window.location.host),k0(),e=new WebSocket(`ws://${window.location.host}`),e.onopen=s=>{i=!0,r({msg:Yo.map(a=>a.name).join("|"),type:"loaded"})},e.onmessage=s=>{if(console.log(typeof s.data,s.data),s.data instanceof Blob){s.data.text().then(o=>{const c=o.indexOf(`
`),l=JSON.parse(o.substring(0,c));l.msg.db=o.substring(c+1),Gc(l,r)});return}if(typeof s.data!="string")return;const a=JSON.parse(s.data);Gc(a,r)}}),mr(),Q0(n,{postMessage:r}),Ci()}Af(tx,{target:document.getElementById("app")});
