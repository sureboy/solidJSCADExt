...
#define LOW_PRECISION`),t}function vv(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Ru?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===kf?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Pn&&(t="SHADOWMAP_TYPE_VSM"),t}function xv(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case ur:case hr:t="ENVMAP_TYPE_CUBE";break;case ia:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Mv(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case hr:t="ENVMAP_MODE_REFRACTION";break}return t}function Sv(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case rl:t="ENVMAP_BLENDING_MULTIPLY";break;case sd:t="ENVMAP_BLENDING_MIX";break;case ad:t="ENVMAP_BLENDING_ADD";break}return t}function Ev(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function yv(n,t,e,i){const r=n.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=vv(e),l=xv(e),u=Mv(e),h=Sv(e),d=Ev(e),p=uv(e),_=hv(s),v=r.createProgram();let m,f,b=e.glslVersion?"#version "+e.glslVersion+`
...
`}}}const Sr=new Jd,ni=new Qi,Er=new Qi,d0=new lp(16777147,16777147,.6);Sr.add(d0);const $r=new gl(16777215,1);$r.position.set(5,10,7);$r.castShadow=!0;$r.shadow.mapSize.width=2048;$r.shadow.mapSize.height=2048;Er.add($r);const p0=new hp(4210752,.3);Er.add(p0);const oh=new gl(16777215,.3);oh.position.set(-5,5,-5);Er.add(oh);const lh=new gl(16777215,.4);lh.position.set(0,5,-10);Er.add(lh);const ch=new dp(20);Er.add(ch);Sr.background=null;let ae=new We(40,1,.1,2e3),Nr,vi,pr;Sr.add(ni);Sr.add(Er);const uh=n=>new vr().setFromObject(n).getSize(new D),qo=n=>{const t=uh(n);let e=t.length();return console.log(t,e),e||(e=qo(ch)),e},m0=new f0,_0=()=>m0.parse(ni,{binary:!0});let mi=15,Ws=!1,hh=1;const g0={front:{position:new D(0,0,1),up:new D(0,1,0)},back:{position:new D(0,0,-1),up:new D(0,1,0)},left:{position:new D(-1,0,0),up:new D(0,1,0)},right:{position:new D(1,0,0),up:new D(0,1,0)},top:{position:new D(0,1,0),up:new D(0,0,-1)},bottom:{position:new D(0,-1,0),up:new D(0,0,1)}},v0={front:{position:new D(0,0,mi),up:new D(0,1,0)},back:{position:new D(0,0,-mi),up:new D(0,1,0)},left:{position:new D(-mi,0,0),up:new D(0,1,0)},right:{position:new D(mi,0,0),up:new D(0,1,0)},top:{position:new D(0,mi,0),up:new D(0,0,-1)},bottom:{position:new D(0,-mi,0),up:new D(0,0,1)}};function fh(n){const e=(Ws?v0:g0)[n];console.log(n,e),e&&(ae.position.copy(Ws?e.position:x0(ni,e.position.clone())),ae.up.copy(e.up),ae.lookAt(0,0,0),vi.target.set(0,0,0),vi.update())}function x0(n,t){const e=new D(t[0]&1^1,t[1]&1^1,t[1]&1^1),r=uh(n).multiply(e).length(),s=hh*(Math.PI/180),a=r/2/Math.tan(s/2);return t.multiplyScalar(a)}function oa(n,t="Perspective"){if(Nr){if(t==="Orthographic"){Ws=!0;const e=n.width/n.height,i=qo(ni)/2;ae&&ae.clear(),ae=new _l(0,0,0,0,.1,2e3),ae.left=-i*e,ae.right=i*e,ae.top=i,ae.bottom=-i,ae.position.set(0,0,-i),mi=i,Yo(n)}else if(t==="Perspective"){Ws=!1,ae&&ae.clear(),ae=new We(40,1,.1,2e3);const e=qo(ni);hh=ae.fov;const i=ae.fov*(Math.PI/180);ae.position.z=e/2/Math.tan(i/2),ae.aspect=n.width/n.height,Yo(n)}ae.updateProjectionMatrix(),Nr.setSize(n.width,n.height),Nr.render(Sr,ae),fh("front")}}const Xc=()=>{requestAnimationFrame(()=>{Nr.render(Sr,ae)})},Yo=n=>{vi?(vi.object=ae,vi.removeEventListener("change",Xc)):vi=new Qv(ae,n),vi.addEventListener("change",Xc)},Ml=(n,t=!1)=>{Nr=new $v({antialias:!0,alpha:!0,canvas:n,preserveDrawingBuffer:!0}),Yo(n)},M0=n=>{n!==pr?(pr=n,Ml(n)):ni.clear()},S0=new Wo({color:30932,specular:1118481,shininess:200}),E0=(n,t)=>{n!==pr&&(pr=n,Ml(n)),ni.add(new ln(t,S0)),oa(n)},y0=(n,...t)=>{n!==pr&&(pr=n,Ml(n)),ni.add(...t)};let Xs;const T0=n=>{n.el=Hu(),n.el.width=document.body.clientWidth,n.el.height=document.body.clientHeight,Xs.innerHTML="",Xs.appendChild(n.el),window.addEventListener("resize",()=>{n.el.width=document.body.clientWidth,n.el.height=document.body.clientHeight,oa(n.el,n.workermsg.cameraType)})};var b0=_r('<div style="position: absolute;left:0;top:0;z-index: 1;"></div>');function A0(n,t){ri(t,!1),wu();var e=b0();As(e,i=>Xs=i,()=>Xs),gr(n,e),si()}const ar=new Map,Fr=new Map,qc=window.includeImport,dh=(n,t,e)=>{let i;for(;(i=t.exec(n))!==null;)e(i,t.lastIndex)},w0=n=>{const t=/import\s*(?:(?:(?:\w+|\*\s*as\s*\w+|\{[^}]*\})\s+from\s+)?['"]([^'"]+)['"]|['"]([^'"]+)['"])/g,e=[];return dh(n,t,(i,r)=>{const s=i[1]||i[2],a=Math.max(i[0].indexOf("'"),i[0].indexOf('"')),o=i.index+a+1;e.push({moduleName:s,startPosition:o,endPosition:o+s.length})}),e},Wr=async(n,t,e=new Set)=>{let i="";if(e.add(n),!!n.srcList){for(const r of n.srcList){if(typeof r=="string"){i+=r;continue}const s=await r();s.db&&(e.has(s)||await Wr(s,t,e)),i+=s.name}i&&t(n.name,i)}},Ci=(n,t)=>new Promise((e,i)=>{if(n.startsWith("./")||qc[n]&&(n=qc[n]),ar.has(n)){e(ar.get(n));return}if(!t){console.log("not reqmsg",n),e(jo({name:n}));return}t({type:"req",path:n});const r=setTimeout(()=>{Fr.delete(n),e(jo({name:n}))},2e3);Fr.set(n,s=>{clearTimeout(r),e(s),Fr.delete(n)})}),R0=new TextDecoder,ph=n=>{n.url&&(URL.revokeObjectURL(n.url),n.url="",n.persons.forEach(t=>{ph(t)}))},C0=(n,t,e)=>{if(ph(n),n.srcList=[],!t.db)return;let i="";if(typeof t.db=="string")i=t.db;else if(t.db instanceof ArrayBuffer)i=R0.decode(t.db);else{console.log(t,typeof t.db);return}let r=0;w0(i).forEach(s=>{n.srcList.push(i.slice(r,s.startPosition)),n.srcList.push(()=>Ci(s.moduleName,e)),r=s.endPosition}),n.srcList.push(i.slice(r))},P0=async n=>{if(n.url)return n.url;if(!n.srcList)return n.name;let t="";for(const e of n.srcList)if(typeof e=="string")t+=e;else{const i=await e();t+=await i.getUri(),typeof i!="string"&&i.persons&&i.persons.add(n)}return t?(n.url=URL.createObjectURL(new Blob([t],{type:"application/javascript"})),n.url):n.name},jo=n=>{const t={persons:new Set,getUri:async()=>P0(t),...n};return t},D0=n=>{ar.delete(n)},mh=(n,t)=>{if(!n.name)return;let e;ar.has(n.name)?e=ar.get(n.name):(e=jo(n),ar.set(n.name,e)),C0(e,n,t),Fr.has(n.name)&&Fr.get(n.name)(e)};var L0=_r('<details><summary style="cursor:pointer;height:48px;text-align:left;line-height: 48px;">Download</summary> <div><button style="height:48:px;line-height:48px;cursor: pointer;">STL</button> <button style="height:48:px;line-height:48px;cursor: pointer;">Gzip</button></div></details>');function U0(n,t){ri(t,!0);const e=()=>{const l=_0(),u=new Blob([l.buffer],{type:"application/octet-stream"}),h=document.createElement("a");h.href=URL.createObjectURL(u),h.download=`${t.workermsg.name}_${t.workermsg.main}_${t.workermsg.index.split(".").shift()}_${Date.now()}.stl`,h.click(),URL.revokeObjectURL(h.href)},i=async()=>{if(!window.CompressionStream||!window.DecompressionStream){console.log("down code err");return}let l=t.workermsg.index;l.startsWith("./")||(l="./"+l);const u=await Ci("./lib/csgChange.js"),h=await Ci(l);let d="";await Wr(u,(m,f)=>{d+=`
/**${m}*/
${f}
`}),await Wr(h,(m,f)=>{d+=`
/**${m}*/
${f}
`});const p=await r(d),_=new Blob(p,{type:"application/gzip"}),v=document.createElement("a");v.href=URL.createObjectURL(_),v.download=`${t.workermsg.name}_${t.workermsg.main}_${t.workermsg.index.split(".").shift()}_${Date.now()}.mgtoy.gz`,v.click(),URL.revokeObjectURL(v.href)},r=async l=>{const u=new TextEncoder().encode(l),h=new ReadableStream({start(m){m.enqueue(u),m.close()}}),d=new CompressionStream("gzip"),_=h.pipeThrough(d).getReader(),v=[];for(;;){const{done:m,value:f}=await _.read();if(m)break;v.push(f)}return v};var s=L0(),a=bi(In(s),2),o=In(a);o.__click=e;var c=bi(o,2);c.__click=i,gr(n,s),si()}nl(["click"]);let qs,Ko,Or;const I0=n=>{qs.innerHTML="",Or.textContent=n.basename,console.log("change Main name",Or),n.list.forEach(t=>{const e=Ko.cloneNode(!0);e.textContent=t,qs.appendChild(e)})};var N0=_r('<details><summary style="cursor: pointer;height:48px;text-align: left;line-height: 48px;">...</summary>  <div style="color:white;text-align: center;" id="module_list"><button style="height:48:px;line-height:48px;cursor: pointer;">...</button></div></details>');function F0(n,t){ri(t,!0);var e=N0(),i=In(e);As(i,a=>Or=a,()=>Or);var r=bi(i,2);r.__click=a=>{const o=a.target.closest("button");console.log(o.textContent),o.textContent!=="..."&&(Or.textContent="...",t.Clickhandle(o.textContent))};var s=In(r);As(s,a=>Ko=a,()=>Ko),As(r,a=>qs=a,()=>qs),gr(n,e),si()}nl(["click"]);let Dr=!0,Ys=xi(["View",""]),_h=Cn("[ U ]");function O0(){Ys[0]=Dr?"[ V ]":"[ U ]",Ys[1]="[ Z ]"}function B0(){return Dr=!Dr,hn(_h,Dr?"[ U ]":"[ V ]",!0),Dr?"Perspective":"Orthographic"}var z0=(n,t,e)=>{const i=n.target.closest("button");i.id&&(i.id!=="camera"?t[1]=i.textContent:(t[0]=i.textContent,t[1]="[ Z ]"),e.Clickhandle(i.id))},k0=_r('<details><summary style="cursor:pointer;height:48px;text-align:left;line-height: 48px;"> </summary>  <div style="color:white;"><button id="camera" class="option-text" style="height:48:px;line-height:48px;cursor: pointer;"> </button> <button id="front" class="option-text" style="height:48:px;line-height:48px;cursor: pointer;">[ Z ]</button> <button id="back" class="option-text" style="height:48:px;line-height:48px;cursor: pointer;">[-Z ]</button> <button id="top" class="option-text" style="height:48:px;line-height:48px;cursor: pointer;">[ Y ]</button> <button id="bottom" class="option-text" style="height:48:px;line-height:48px;cursor: pointer;">[-Y ]</button> <button id="left" class="option-text" style="height:48:px;line-height:48px;cursor: pointer;">[ X ]</button> <button id="right" class="option-text" style="height:48:px;line-height:48px;cursor: pointer;">[-X ]</button></div></details>');function H0(n,t){ri(t,!0);var e=k0(),i=In(e),r=In(i),s=bi(i,2);s.__click=[z0,Ys,t];var a=In(s),o=In(a);_f(c=>{Ol(r,c),Ol(o,Ne(_h))},[()=>Ys.join(" ")]),gr(n,e),si()}nl(["click"]);const Yc=!1,Xr={mesh:{def:new Wo({color:34001,flatShading:Yc}),make:n=>new Wo({...n,flatShading:Yc})},line:{def:new Hs({color:255}),make:n=>new Hs(n)},lines:null};Xr.lines=Xr.line;Xr.instance=Xr.mesh;function V0(n,{smooth:t=!1}){const{vertices:e,indices:i,normals:r,color:s,colors:a,isTransparent:o=!1,opacity:c}=n;let{transforms:l}=n;const u=n.type||"mesh",h=Xr[u];if(!h){console.error(`material not found for type ${u}`,n);return}let d=h.def;if(s||a){const v=s||a,m={vertexColors:!!a,opacity:v[3]===void 0?1:v[3],transparent:s&&v[3]!==1&&v[3]!==void 0||o};c&&(m.opacity=c),a||(m.color=new zt(s[0],s[1],s[2])),d=h.make(m),c&&(d.transparent=!0,d.opacity=c)}let p=new Qe;p.setAttribute("position",new ve(e,3)),i&&p.setIndex(new ve(i,1)),r&&p.setAttribute("normal",new ve(r,3)),t&&(p=G0(p,Math.PI/10)),a&&p.setAttribute("color",new ve(a,o?4:3));let _;switch(u){case"mesh":_=new ln(p,d);break;case"line":_=new $u(p,d);break;case"lines":_=new Ju(p,d);break}return l&&_.applyMatrix4({elements:l}),_}function G0(n,t=Math.PI/3){const e=Math.cos(t),i=(1+1e-10)*100,r=[new D,new D,new D],s=new D,a=new D,o=new D,c=new D;function l(v){const m=~~(v.x*i),f=~~(v.y*i),b=~~(v.z*i);return`${m},${f},${b}`}const u=n.index?n.toNonIndexed():n,h=u.attributes.position,d={};for(let v=0,m=h.count/3;v<m;v++){const f=3*v,b=r[0].fromBufferAttribute(h,f+0),T=r[1].fromBufferAttribute(h,f+1),E=r[2].fromBufferAttribute(h,f+2);s.subVectors(E,T),a.subVectors(b,T);const C=new D().crossVectors(s,a).normalize();for(let w=0;w<3;w++){const R=r[w],U=l(R);U in d||(d[U]=[]),d[U].push(C)}}const p=new Float32Array(h.count*3),_=new ve(p,3,!1);for(let v=0,m=h.count/3;v<m;v++){const f=3*v,b=r[0].fromBufferAttribute(h,f+0),T=r[1].fromBufferAttribute(h,f+1),E=r[2].fromBufferAttribute(h,f+2);s.subVectors(E,T),a.subVectors(b,T),o.crossVectors(s,a).normalize();for(let C=0;C<3;C++){const w=r[C],R=l(w),U=d[R];c.set(0,0,0);for(let S=0,M=U.length;S<M;S++){const P=U[S];o.dot(P)>e&&c.add(P)}c.normalize(),_.setXYZ(f+C,c.x,c.y,c.z)}}return u.setAttribute("normal",_),u}const W0=`
...
};`;let Rn;const q0=async(n,t)=>{const i=await(await Ci("./lib/csgChange.js",t)).getUri();let r=n.index;r.startsWith("./")||(r="./"+r);const a=await(await Ci(r,t)).getUri(),o=`import * as csg  from '${i}'
...
${X0} `;return console.log(o),URL.createObjectURL(new Blob([o],{type:"application/javascript"}))},Sl=n=>{Rn&&(Rn.terminate(),Rn=null),n.postMessage({type:"start"}),n.showMenu=1,q0(n.workermsg,n.postMessage).then(t=>{Rn=new Worker(t,{type:"module"}),Rn.onerror=e=>{console.error("error",e),n.postMessage({type:"error",msg:"Code syntax error"})},Rn.onmessageerror=e=>{console.error("messageErr",e),n.postMessage({type:"error",msg:e.data})},Rn.onmessage=function(e){const i=e.data;if(console.log(e,i),i.start)try{M0(n.el)}catch(r){n.postMessage({type:"initError",msg:r.error})}i.ver&&y0(n.el,V0(i.ver,{})),i.end&&(i.module&&n.workermsg.module(i.module),console.log("cameraType",n.workermsg.cameraType),oa(n.el,n.workermsg.cameraType),Rn?.terminate(),URL.revokeObjectURL(t),Rn=null,n.postMessage({type:"end"}),n.showMenu=7),i.log&&n.postMessage({type:"log",msg:i.log}),i.error&&n.postMessage({type:"error",msg:i.error})}})};var Y0=_r('<div style="position: absolute;left:5px;top:5px;z-index: 11;cursor: pointer;" class="pointer-events-auto" id="camera-toggle"><!> <!> <!></div>');function j0(n,t){ri(t,!0);const e=If(t,"solidConfig"),i=window.myConfig,r={...i,cameraType:"Perspective",module:p=>{I0(p)}};e().workermsg=r;const s=new Map;s.set("camera",()=>{e().workermsg.cameraType=B0(),oa(e().el,e().workermsg.cameraType)});var a=Y0(),o=In(a);{var c=p=>{F0(p,{Clickhandle:_=>{e().workermsg.main=_,O0(),Sl(e())}})};ua(o,p=>{(e().showMenu&1)!==0&&p(c)})}var l=bi(o,2);{var u=p=>{H0(p,{Clickhandle:_=>{console.log(_),s.has(_)?s.get(_)():fh(_)}})};ua(l,p=>{(e().showMenu&2)!==0&&p(u)})}var h=bi(l,2);{var d=p=>{U0(p,{get workermsg(){return i}})};ua(h,p=>{(e().showMenu&4)!==0&&p(d)})}gr(n,a),si()}const K0=async n=>{const t=new DecompressionStream("gzip"),e=t.writable.getWriter();e.write(n),e.close();const r=await new Response(t.readable).arrayBuffer();let s="";try{s=new TextDecoder().decode(r)}catch(a){console.error(a)}return s},Z0=(n,t)=>{let e="",i=0;dh(n,/\/\*\*\s*([\w\.\/]+)\s*\*/g,(r,s)=>{e&&t({name:e,db:n.slice(i,r.index).trim()}),e=r[1],i=s+1}),e&&t({name:e,db:n.slice(i).trim()})};class $0 extends pl{constructor(t){super(t)}load(t,e,i,r){const s=this,a=new op(this.manager);a.setPath(this.path),a.setResponseType("arraybuffer"),a.setRequestHeader(this.requestHeader),a.setWithCredentials(this.withCredentials),a.load(t,function(o){try{e(s.parse(o))}catch(c){r?r(c):console.error(c),s.manager.itemError(t)}},i,r)}parse(t){function e(l){const u=new DataView(l),h=32/8*3+32/8*3*3+16/8,d=u.getUint32(80,!0);if(80+32/8+d*h===u.byteLength)return!0;const _=[115,111,108,105,100];for(let v=0;v<5;v++)if(i(_,u,v))return!1;return!0}function i(l,u,h){for(let d=0,p=l.length;d<p;d++)if(l[d]!==u.getUint8(h+d))return!1;return!0}function r(l){const u=new DataView(l),h=u.getUint32(80,!0);let d,p,_,v=!1,m,f,b,T,E;for(let P=0;P<70;P++)u.getUint32(P,!1)==1129270351&&u.getUint8(P+4)==82&&u.getUint8(P+5)==61&&(v=!0,m=new Float32Array(h*3*3),f=u.getUint8(P+6)/255,b=u.getUint8(P+7)/255,T=u.getUint8(P+8)/255,E=u.getUint8(P+9)/255);const C=84,w=50,R=new Qe,U=new Float32Array(h*3*3),S=new Float32Array(h*3*3),M=new zt;for(let P=0;P<h;P++){const O=C+P*w,H=u.getFloat32(O,!0),j=u.getFloat32(O+4,!0),X=u.getFloat32(O+8,!0);if(v){const G=u.getUint16(O+48,!0);(G&32768)===0?(d=(G&31)/31,p=(G>>5&31)/31,_=(G>>10&31)/31):(d=f,p=b,_=T)}for(let G=1;G<=3;G++){const K=O+G*12,k=P*3*3+(G-1)*3;U[k]=u.getFloat32(K,!0),U[k+1]=u.getFloat32(K+4,!0),U[k+2]=u.getFloat32(K+8,!0),S[k]=H,S[k+1]=j,S[k+2]=X,v&&(M.setRGB(d,p,_,Ge),m[k]=M.r,m[k+1]=M.g,m[k+2]=M.b)}}return R.setAttribute("position",new ve(U,3)),R.setAttribute("normal",new ve(S,3)),v&&(R.setAttribute("color",new ve(m,3)),R.hasColors=!0,R.alpha=E),R}function s(l){const u=new Qe,h=/solid([\s\S]*?)endsolid/g,d=/facet([\s\S]*?)endfacet/g,p=/solid\s(.+)/;let _=0;const v=/[\s]+([+-]?(?:\d*)(?:\.\d*)?(?:[eE][+-]?\d+)?)/.source,m=new RegExp("vertex"+v+v+v,"g"),f=new RegExp("normal"+v+v+v,"g"),b=[],T=[],E=[],C=new D;let w,R=0,U=0,S=0;for(;(w=h.exec(l))!==null;){U=S;const M=w[0],P=(w=p.exec(M))!==null?w[1]:"";for(E.push(P);(w=d.exec(M))!==null;){let j=0,X=0;const G=w[0];for(;(w=f.exec(G))!==null;)C.x=parseFloat(w[1]),C.y=parseFloat(w[2]),C.z=parseFloat(w[3]),X++;for(;(w=m.exec(G))!==null;)b.push(parseFloat(w[1]),parseFloat(w[2]),parseFloat(w[3])),T.push(C.x,C.y,C.z),j++,S++;X!==1&&console.error("THREE.STLLoader: Something isn't right with the normal of face number "+_),j!==3&&console.error("THREE.STLLoader: Something isn't right with the vertices of face number "+_),_++}const O=U,H=S-U;u.userData.groupNames=E,u.addGroup(O,H,R),R++}return u.setAttribute("position",new Xe(b,3)),u.setAttribute("normal",new Xe(T,3)),u}function a(l){return typeof l!="string"?new TextDecoder().decode(l):l}function o(l){if(typeof l=="string"){const u=new Uint8Array(l.length);for(let h=0;h<l.length;h++)u[h]=l.charCodeAt(h)&255;return u.buffer||u}else return l}const c=o(t);return e(c)?r(c):s(a(t))}}const _n=xi({showMenu:1}),J0={name:"del",fn:n=>{D0(n.name)}},Q0={name:"init",fn:(n,t)=>{mh(n,t)}},tx={fn:(n,t)=>{Object.assign(_n.workermsg,{cameraType:n.open?_n.workermsg.cameraType:""}),Sl(_n)},name:"run"},ex={fn:(n,t)=>{let e=_n.workermsg.index;e.startsWith("./")||(e="./"+e),Ci(e,t).then(i=>{console.log(i),Wr(i,(r,s)=>{t({type:"src",name:r,code:s})}).then(()=>{Ci("./lib/csgChange.js",t).then(r=>{Wr(r,(s,a)=>{t({type:"src",name:s,code:a})}).then(()=>{t({type:"src"})})})})})},name:"getSrc"},nx={fn:(n,t)=>{K0(n.db).then(e=>{Z0(e,i=>{mh(i)}),console.log(_n),Sl(_n)})},name:"gzData"},ix={fn:n=>{E0(_n.el,new $0().parse(n.db)),_n.showMenu=4},name:"stlData"},Zo=[Q0,J0,tx,ex,nx,ix],rx=n=>{function*t(){for(let e=0;e<Zo.length;e++)(n&1<<e)!==0&&(yield Zo[e])}return t()},jc=(n,t)=>{console.log("messagepost",n);for(const e of rx(n.type))e.fn(n.msg,t)};var sx=_r("<!> <!>",1);function ax(n,t){ri(t,!0);var e=sx(),i=of(e);A0(i,{});var r=bi(i,2);j0(r,{get solidConfig(){return _n}}),gr(n,e),si()}var Wa=Uf(()=>_n);function ox(n,t){ri(t,!1);let e,i=!1;const r=s=>{if(!i){console.log("not open",s);return}e.send(JSON.stringify(s))};Nf(()=>{console.log("href",window.location.href),T0(Wa()),e=new WebSocket(`ws://${window.location.host}`),e.onopen=s=>{i=!0,r({msg:Zo.map(a=>a.name).join("|"),type:"loaded"})},e.onmessage=s=>{if(console.log(typeof s.data,s.data),s.data instanceof Blob){s.data.text().then(o=>{const c=o.indexOf(`
`),l=JSON.parse(o.substring(0,c));l.msg.db=o.substring(c+1),jc(l,r)});return}if(typeof s.data!="string")return;const a=JSON.parse(s.data);jc(a,r)}}),Wa(Wa().postMessage=r),wu(),ax(n,{}),si()}Cf(ox,{target:document.getElementById("app")});
