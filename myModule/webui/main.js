...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function ZL(r,e,t){const n=new Float32Array(ai),i=new B(0,1,0);return new nr({name:"SphericalGaussianBlur",defines:{n:ai,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:La(),fragmentShader:`
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function r_(){return new nr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:La(),fragmentShader:`
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function i_(){return new nr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:La(),fragmentShader:`
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function La(){return`
