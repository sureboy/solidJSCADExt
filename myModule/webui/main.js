...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function YL(r,e,t){const n=new Float32Array(si),i=new B(0,1,0);return new tr({name:"SphericalGaussianBlur",defines:{n:si,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Na(),fragmentShader:`
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function r_(){return new tr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Na(),fragmentShader:`
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function i_(){return new tr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Na(),fragmentShader:`
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function Na(){return`
...
`)}const h_=new Ve;function KI(r){Qe._getMatrix(h_,Qe.workingColorSpace,r);const e=`mat3( ${h_.elements.map(t=>t.toFixed(4))} )`;switch(Qe.getTransfer(r)){case ga:return[e,"LinearTransferOETF"];case at:return[e,"sRGBTransferOETF"];default:return Ie("WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function d_(r,e,t){const n=r.getShaderParameter(e,r.COMPILE_STATUS),s=(r.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`
...
`)+`
`+p);const x=_+m+o,y=_+p+a,M=f_(i,i.VERTEX_SHADER,x),E=f_(i,i.FRAGMENT_SHADER,y);i.attachShader(v,M),i.attachShader(v,E),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function w(T){if(r.debug.checkShaderErrors){const R=i.getProgramInfoLog(v)||"",L=i.getShaderInfoLog(M)||"",C=i.getShaderInfoLog(E)||"",I=R.trim(),N=L.trim(),F=C.trim();let k=!0,G=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(k=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,v,M,E);else{const H=d_(i,M,"vertex"),Y=d_(i,E,"fragment");tt("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
