...
};`;let wn;const B0=async(n,t)=>{const i=await(await Hr("csgChange",t)).getUri();let r=n.index;r.startsWith("./")||(r="./"+r);const a=await(await Hr(r,t)).getUri(),o=`import * as csg  from '${i}'
