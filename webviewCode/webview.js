...
import * as src  from '${ho("./index.js")}'
${zv} 
 const main = "${n}";
...
${Hv} `],{type:"application/javascript"})),dc=(n,t)=>{Ci&&Ci.terminate();const e=kv(t.basename);Ci=new Worker(e,{type:"module"}),Ci.onmessage=function(i){const r=i.data;console.log(r),r.start?Cv(n):r.ver?Pv(n,Ov(r.ver,{})):r.end?(r.module&&t.module(r.module),co(n,t.cameraType),Ci?.terminate(),URL.revokeObjectURL(e),Ci=null,is.postMessage({type:"end"})):r.log?is.postMessage({type:"log",msg:r.log}):r.error&&is.postMessage({type:"error",msg:r.error})}};var Vv=kh('<div style="position: absolute;left:0;top:0;z-index: 1;"></div> <div style="position: absolute;right:5px;top:5px;z-index: 11;" class="pointer-events-auto "><details name="downMenu"><summary class="download-summary svelte-jtp4lu"><svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M24 32L24 16M24 32L18 26M24 32L30 26" stroke="#3498db" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10 38H38" stroke="#3498db" stroke-width="3" stroke-linecap="round"></path></svg></summary> <div class="download-options svelte-jtp4lu"><div class="download-option svelte-jtp4lu"><span class="option-text svelte-jtp4lu" id="downSTL">STL</span></div></div></details></div> <div style="position: absolute;left:5px;top:5px;z-index: 11;" class="pointer-events-auto" id="camera-toggle"><svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="1" width="46" height="46" rx="4" fill="#2d2d2d" stroke="#555" stroke-width="1"></rect><g id="perspective-icon" transform="translate(8, 8) scale(0.8)"><path d="M6 6 L26 6 L36 26 L16 26 Z" fill="none" stroke="#4fc3f7" stroke-width="2" stroke-linejoin="round"></path><path d="M6 6 L16 26" stroke="#4fc3f7" stroke-width="2"></path><path d="M26 6 L36 26" stroke="#4fc3f7" stroke-width="2"></path><circle cx="21" cy="1" r="3" fill="#4fc3f7"></circle><line x1="21" y1="4" x2="21" y2="6" stroke="#4fc3f7" stroke-width="2"></line></g><g id="orthographic-icon" transform="translate(8, 8) scale(0.8)" opacity="0.5"><rect x="6" y="6" width="30" height="20" fill="none" stroke="#81c784" stroke-width="2" stroke-linejoin="round"></rect><line x1="6" y1="6" x2="1" y2="1" stroke="#81c784" stroke-width="2"></line><line x1="36" y1="6" x2="41" y2="1" stroke="#81c784" stroke-width="2"></line><line x1="36" y1="26" x2="41" y2="31" stroke="#81c784" stroke-width="2"></line><line x1="6" y1="26" x2="1" y2="31" stroke="#81c784" stroke-width="2"></line></g><rect x="12" y="36" width="24" height="4" rx="2" fill="#555"></rect><rect id="toggle-indicator" x="12" y="36" width="12" height="4" rx="2" fill="#4fc3f7"></rect></svg></div> <div style="position:absolute;left:0px;top:5px;z-index:10;width:100%;font-weight: 500;" class="pointer-events-auto"><details name="moduleMenu"><summary style="cursor: pointer;height:48px;text-align: center;line-height: 48px;"> </summary> <div style="color:white;text-align: center;" id="module_list"><button style="height:48:px;line-height:48px;">STL</button></div></details></div>',1);function Gv(n,t){Mc(t,!1);let e=$o(),i,r=$o("....");Kh(()=>{document.getElementById("downSTL").addEventListener("click",P=>{const A=Rv(),I=new Blob([A.buffer],{type:"application/octet-stream"}),M=document.createElement("a");M.href=URL.createObjectURL(I),M.download=`${ze(r)}.stl`,M.click(),URL.revokeObjectURL(M.href)}),is.postMessage({type:"loaded"}),i=nu(),i.width=document.body.clientWidth,i.height=document.body.clientHeight,ph(e,ze(e).innerHTML=""),ze(e).appendChild(i);const f=document.getElementById("camera-toggle"),d=document.getElementById("perspective-icon"),p=document.getElementById("orthographic-icon"),g=document.getElementById("toggle-indicator");let v=!0,m="Perspective";function u(){v=!v,d.setAttribute("opacity",v?"1":"0.5"),p.setAttribute("opacity",v?"0.5":"1"),g.setAttribute("x",v?"12":"24"),m=v?"Perspective":"Orthographic",co(i,m)}f.addEventListener("click",u);const b=()=>{i.width=document.body.clientWidth,i.height=document.body.clientHeight,co(i,m)};window.addEventListener("resize",b);const T=document.getElementById("module_list");T.addEventListener("click",P=>{const A=P.target.closest("button");console.log(A.textContent),C.basename=A.textContent,Je(r,"...."),dc(i,C)});const E=T.firstChild,C={basename:"",cameraType:"",module:P=>{Je(r,P.basename),T.innerHTML="",P.list.forEach(A=>{const I=E.cloneNode(!0);I.textContent=A,T.appendChild(I)})}};return window.addEventListener("message",P=>{const A=P.data;A.init&&Fv(A.init),A.run&&(C.cameraType=A.open?m:"",dc(i,C))}),()=>{}}),jh();var s=Vv(),a=gh(s);Yh(a,f=>Je(e,f),()=>ze(e));var o=vh(a,6),c=Us(o),l=Us(c),h=Us(l);bh(()=>Gh(h,ze(r))),Vh(n,s),Sc()}Wh(Gv,{target:document.getElementById("app")});
