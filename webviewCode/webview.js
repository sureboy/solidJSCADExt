...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function vc(){return new ii({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:pl(),fragmentShader:`
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function xc(){return new ii({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:pl(),fragmentShader:`
...
#define LOW_PRECISION`),t}function pv(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===wu?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Ff?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Rn&&(t="SHADOWMAP_TYPE_VSM"),t}function mv(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case or:case lr:t="ENVMAP_TYPE_CUBE";break;case ea:t="ENVMAP_TYPE_CUBE_UV";break}return t}function _v(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case lr:t="ENVMAP_MODE_REFRACTION";break}return t}function gv(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case tl:t="ENVMAP_BLENDING_MULTIPLY";break;case ed:t="ENVMAP_BLENDING_MIX";break;case nd:t="ENVMAP_BLENDING_ADD";break}return t}function vv(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function xv(n,t,e,i){const r=n.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=pv(e),l=mv(e),u=_v(e),f=gv(e),d=vv(e),p=av(e),_=ov(s),v=r.createProgram();let m,h,y=e.glslVersion?"#version "+e.glslVersion+`
`:"";e.isRawShaderMaterial?(m=["#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,_].filter(Rr).join(`
`),m.length>0&&(m+=`
`),h=["#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,_].filter(Rr).join(`
`),h.length>0&&(h+=`
...
`}}}const vr=new jd,bi=new $i,xr=new $i,c0=new rp(16777147,16777147,.6);vr.add(c0);const Kr=new dl(16777215,1);Kr.position.set(5,10,7);Kr.castShadow=!0;Kr.shadow.mapSize.width=2048;Kr.shadow.mapSize.height=2048;xr.add(Kr);const u0=new op(4210752,.3);xr.add(u0);const ah=new dl(16777215,.3);ah.position.set(-5,5,-5);xr.add(ah);const oh=new dl(16777215,.4);oh.position.set(0,5,-10);xr.add(oh);const lh=new cp(20);xr.add(lh);vr.background=null;const ch=new je(40,1,.1,2e3),h0=new fl(0,0,0,0,.1,2e3);let we=ch,Dr,wr,hr;vr.add(bi);vr.add(xr);const Vo=n=>{let i=new mr().setFromObject(n).getSize(new I).length();return i||(i=Vo(lh)),i},f0=new l0,d0=()=>f0.parse(bi,{binary:!0});function sa(n,t="Perspective"){if(Dr){if(t==="Orthographic"){const e=n.width/n.height,i=Vo(bi)/2;we=h0,we.left=-i*e,we.right=i*e,we.top=i,we.bottom=-i,we.position.set(0,0,i),Go(n)}else if(t==="Perspective"){we=ch;const e=Vo(bi),i=we.fov*(Math.PI/180);we.position.z=e/2/Math.tan(i/2),we.aspect=n.width/n.height,Go(n)}we.updateProjectionMatrix(),Dr.setSize(n.width,n.height),Dr.render(vr,we)}}const zc=()=>{requestAnimationFrame(()=>{Dr.render(vr,we)})},Go=n=>{wr?(wr.object=we,wr.removeEventListener("change",zc)):wr=new Kv(we,n),wr.addEventListener("change",zc)},_l=(n,t=!1)=>{Dr=new Yv({antialias:!0,alpha:!0,canvas:n,preserveDrawingBuffer:!0}),Go(n)},p0=n=>{n!==hr?(hr=n,_l(n)):bi.clear()},m0=new ko({color:30932,specular:1118481,shininess:200}),_0=(n,t)=>{n!==hr&&(hr=n,_l(n)),bi.add(new un(t,m0)),sa(n)},g0=(n,...t)=>{n!==hr&&(hr=n,_l(n)),bi.add(...t)};let Wo,Xo,qo,Yi=!0;function v0(){return Yi=!Yi,Wo.setAttribute("opacity",Yi?"1":"0.5"),Xo.setAttribute("opacity",Yi?"0.5":"1"),qo.setAttribute("x",Yi?"12":"24"),Yi?"Perspective":"Orthographic"}var x0=Tf('<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="1" width="46" height="46" rx="4" fill="#2d2d2d" stroke="#555" stroke-width="1"></rect><g id="perspective-icon" transform="translate(8, 8) scale(0.8)"><path d="M6 6 L26 6 L36 26 L16 26 Z" fill="none" stroke="#4fc3f7" stroke-width="2" stroke-linejoin="round"></path><path d="M6 6 L16 26" stroke="#4fc3f7" stroke-width="2"></path><path d="M26 6 L36 26" stroke="#4fc3f7" stroke-width="2"></path><circle cx="21" cy="1" r="3" fill="#4fc3f7"></circle><line x1="21" y1="4" x2="21" y2="6" stroke="#4fc3f7" stroke-width="2"></line></g><g id="orthographic-icon" transform="translate(8, 8) scale(0.8)" opacity="0.5"><rect x="6" y="6" width="30" height="20" fill="none" stroke="#81c784" stroke-width="2" stroke-linejoin="round"></rect><line x1="6" y1="6" x2="1" y2="1" stroke="#81c784" stroke-width="2"></line><line x1="36" y1="6" x2="41" y2="1" stroke="#81c784" stroke-width="2"></line><line x1="36" y1="26" x2="41" y2="31" stroke="#81c784" stroke-width="2"></line><line x1="6" y1="26" x2="1" y2="31" stroke="#81c784" stroke-width="2"></line></g><rect x="12" y="36" width="24" height="4" rx="2" fill="#555"></rect><rect id="toggle-indicator" x="12" y="36" width="12" height="4" rx="2" fill="#4fc3f7"></rect></svg>');function M0(n){var t=x0(),e=In(ln(t));Mi(e,s=>Wo=s,()=>Wo);var i=In(e);Mi(i,s=>Xo=s,()=>Xo);var r=In(i,2);Mi(r,s=>qo=s,()=>qo),Wr(n,t)}const rr=new Map,Gs=new Map,kc=window.includeImport,uh=(n,t,e)=>{let i;for(;(i=t.exec(n))!==null;)e(i,t.lastIndex)},S0=n=>{const t=/import\s*(?:(?:(?:\w+|\*\s*as\s*\w+|\{[^}]*\})\s+from\s+)?['"]([^'"]+)['"]|['"]([^'"]+)['"])/g,e=[];return uh(n,t,(i,r)=>{const s=i[1]||i[2],a=Math.max(i[0].indexOf("'"),i[0].indexOf('"')),o=i.index+a+1;e.push({moduleName:s,startPosition:o,endPosition:o+s.length})}),e},gl=async(n,t,e=new Set)=>{let i="";if(e.add(n),!!n.srcList){for(const r of n.srcList){if(typeof r=="string"){i+=r;continue}const s=await r();s.db&&(e.has(s)||await gl(s,t,e)),i+=s.name}i&&t(n.name,i)}},Hr=(n,t)=>new Promise((e,i)=>{if(n.startsWith("./")||kc[n]&&(n=kc[n]),rr.has(n)){e(rr.get(n));return}if(!t){console.log("not reqmsg",n),e(fh({name:n}));return}t({type:"req",path:n}),Gs.set(n,r=>{e(r),Gs.delete(n)})}),E0=new TextDecoder,hh=n=>{n.url&&(URL.revokeObjectURL(n.url),n.url="",n.persons.forEach(t=>{hh(t)}))},y0=(n,t,e)=>{if(hh(n),n.srcList=[],!t.db)return;const i=typeof t.db=="string"?t.db:E0.decode(t.db);let r=0;S0(i).forEach(s=>{n.srcList.push(i.slice(r,s.startPosition)),n.srcList.push(()=>Hr(s.moduleName,e)),r=s.endPosition}),n.srcList.push(i.slice(r))},T0=async n=>{if(n.url)return n.url;if(!n.srcList)return n.name;let t="";for(const e of n.srcList)if(typeof e=="string")t+=e;else{const i=await e();t+=await i.getUri(),typeof i!="string"&&i.persons&&i.persons.add(n)}return t?(n.url=URL.createObjectURL(new Blob([t],{type:"application/javascript"})),n.url):n.name},fh=n=>{const t={persons:new Set,getUri:async()=>T0(t),...n};return t},b0=n=>{rr.delete(n)},Hc=(n,t)=>{if(!n.name)return;let e;rr.has(n.name)?e=rr.get(n.name):(e=fh(n),rr.set(n.name,e)),y0(e,n,t),Gs.has(n.name)&&Gs.get(n.name)(e)};var A0=ta('<details name="downMenu"><summary class="download-summary svelte-17o52b0"><svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M24 32L24 16M24 32L18 26M24 32L30 26" stroke="#3498db" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10 38H38" stroke="#3498db" stroke-width="3" stroke-linecap="round"></path></svg></summary>  <div class="download-options svelte-17o52b0"><div class="download-option svelte-17o52b0"><div class="option-text svelte-17o52b0">STL</div></div> <div class="download-option svelte-17o52b0"><div class="option-text svelte-17o52b0">Gzip</div></div></div></details>');function w0(n,t){dr(t,!1);let e=Nr(t,"workermsg",8);const i=()=>{const d=d0(),p=new Blob([d.buffer],{type:"application/octet-stream"}),_=document.createElement("a");_.href=URL.createObjectURL(p),_.download=`${e().name}_${e().main}_${e().index.split(".").shift()}_${Date.now()}.stl`,_.click(),URL.revokeObjectURL(_.href)},r=async()=>{if(!window.CompressionStream||!window.DecompressionStream){console.log("down code err");return}const d=await Hr(e().index);let p="";await gl(d,(h,y)=>{p+=`
/**${h}*/
${y}
`});const _=await s(p),v=new Blob(_,{type:"application/gzip"}),m=document.createElement("a");m.href=URL.createObjectURL(v),m.download=`${e().name}_${e().main}_${e().index.split(".").shift()}_${Date.now()}.mgtoy.gz`,m.click(),URL.revokeObjectURL(m.href)},s=async d=>{const p=new TextEncoder().encode(d),_=new ReadableStream({start(b){b.enqueue(p),b.close()}}),v=new CompressionStream("gzip"),h=_.pipeThrough(v).getReader(),y=[];for(;;){const{done:b,value:E}=await h.read();if(b)break;y.push(E)}return y};Xr();var a=A0(),o=In(ln(a),2),c=ln(o),l=ln(c);l.__click=i;var u=In(c,2),f=ln(u);f.__click=r,Wr(n,a),pr()}Jo(["click"]);let Lr,Ws,Ur;const R0=n=>{Lr.innerHTML="",Ur.textContent=n.basename,console.log("change Main name",Ur),n.list.forEach(t=>{const e=Ws.cloneNode(!0);e.textContent=t,Lr.appendChild(e)}),Lr.appendChild(Ws)};var C0=n=>{console.log(n)},P0=ta('<details name="moduleMenu"><summary style="cursor: pointer;height:48px;text-align: center;line-height: 48px;">...</summary>  <div style="color:white;text-align: center;" id="module_list"><button class="option-text" style="height:48:px;line-height:48px;cursor: pointer;">...</button></div></details>');function D0(n,t){dr(t,!1);let e=Nr(t,"Clickhandle",8);Xr();var i=P0(),r=ln(i);Mi(r,o=>Ur=o,()=>Ur);var s=In(r,2);s.__click=o=>{const c=o.target.closest("button");console.log(c.textContent),c.textContent!=="..."&&(Ur.textContent="...",e()(c.textContent))};var a=ln(s);a.__click=[C0],Mi(a,o=>Ws=o,()=>Ws),Mi(s,o=>Lr=o,()=>Lr),Wr(n,i),pr()}Jo(["click"]);const Kn={...window.myConfig,cameraType:"Perspective",module:n=>{R0(n)}};var L0=ta('<div id="downMenuList"><div style="position: absolute;right:5px;top:5px;z-index: 11;cursor: pointer;" class="pointer-events-auto "><!></div> <div style="position:absolute;left:0px;top:5px;z-index:10;width:100%;font-weight: 500;" class="pointer-events-auto"><!></div></div>');function U0(n,t){dr(t,!1);let e=Nr(t,"Clickhandle",8);Xr();var i=L0(),r=ln(i),s=ln(r);w0(s,{get workermsg(){return Kn}});var a=In(r,2),o=ln(a);D0(o,{get Clickhandle(){return e()}}),Wr(n,i),pr()}const Vc=!1,Vr={mesh:{def:new ko({color:34001,flatShading:Vc}),make:n=>new ko({...n,flatShading:Vc})},line:{def:new ks({color:255}),make:n=>new ks(n)},lines:null};Vr.lines=Vr.line;Vr.instance=Vr.mesh;function I0(n,{smooth:t=!1}){const{vertices:e,indices:i,normals:r,color:s,colors:a,isTransparent:o=!1,opacity:c}=n;let{transforms:l}=n;const u=n.type||"mesh",f=Vr[u];if(!f){console.error(`material not found for type ${u}`,n);return}let d=f.def;if(s||a){const v=s||a,m={vertexColors:!!a,opacity:v[3]===void 0?1:v[3],transparent:s&&v[3]!==1&&v[3]!==void 0||o};c&&(m.opacity=c),a||(m.color=new zt(s[0],s[1],s[2])),d=f.make(m),c&&(d.transparent=!0,d.opacity=c)}let p=new tn;p.setAttribute("position",new ve(e,3)),i&&p.setIndex(new ve(i,1)),r&&p.setAttribute("normal",new ve(r,3)),t&&(p=N0(p,Math.PI/10)),a&&p.setAttribute("color",new ve(a,o?4:3));let _;switch(u){case"mesh":_=new un(p,d);break;case"line":_=new Zu(p,d);break;case"lines":_=new $u(p,d);break}return l&&_.applyMatrix4({elements:l}),_}function N0(n,t=Math.PI/3){const e=Math.cos(t),i=(1+1e-10)*100,r=[new I,new I,new I],s=new I,a=new I,o=new I,c=new I;function l(v){const m=~~(v.x*i),h=~~(v.y*i),y=~~(v.z*i);return`${m},${h},${y}`}const u=n.index?n.toNonIndexed():n,f=u.attributes.position,d={};for(let v=0,m=f.count/3;v<m;v++){const h=3*v,y=r[0].fromBufferAttribute(f,h+0),b=r[1].fromBufferAttribute(f,h+1),E=r[2].fromBufferAttribute(f,h+2);s.subVectors(E,b),a.subVectors(y,b);const C=new I().crossVectors(s,a).normalize();for(let w=0;w<3;w++){const R=r[w],L=l(R);L in d||(d[L]=[]),d[L].push(C)}}const p=new Float32Array(f.count*3),_=new ve(p,3,!1);for(let v=0,m=f.count/3;v<m;v++){const h=3*v,y=r[0].fromBufferAttribute(f,h+0),b=r[1].fromBufferAttribute(f,h+1),E=r[2].fromBufferAttribute(f,h+2);s.subVectors(E,b),a.subVectors(y,b),o.crossVectors(s,a).normalize();for(let C=0;C<3;C++){const w=r[C],R=l(w),L=d[R];c.set(0,0,0);for(let S=0,M=L.length;S<M;S++){const P=L[S];o.dot(P)>e&&c.add(P)}c.normalize(),_.setXYZ(h+C,c.x,c.y,c.z)}}return u.setAttribute("normal",_),u}const F0=`
...
};`;let wn;const B0=async(n,t)=>{const i=await(await Hr("./lib/csgChange.js",t)).getUri();let r=n.index;r.startsWith("./")||(r="./"+r);const a=await(await Hr(r,t)).getUri(),o=`import * as csg  from '${i}'
...
${O0} `;return console.log(o),URL.createObjectURL(new Blob([o],{type:"application/javascript"}))},Yo=(n,t,e)=>{wn&&(wn.terminate(),wn=null),e({type:"start"}),B0(t,e).then(i=>{wn=new Worker(i,{type:"module"}),wn.onerror=r=>{console.error("error",r),e({type:"error",msg:"Code syntax error"})},wn.onmessageerror=r=>{console.error("messageErr",r),e({type:"error",msg:r.data})},wn.onmessage=function(r){const s=r.data;console.log(r,s),s.start&&p0(n),s.ver&&g0(n,I0(s.ver,{})),s.end&&(s.module&&t.module(s.module),console.log("cameraType",t.cameraType),sa(n,t.cameraType),wn?.terminate(),URL.revokeObjectURL(i),wn=null,e({type:"end"})),s.log&&e({type:"log",msg:s.log}),s.error&&e({type:"error",msg:s.error})}})};let Xs;const ge={workermsg:Kn},z0=()=>{ge.el=ku(),ge.el.width=document.body.clientWidth,ge.el.height=document.body.clientHeight,Xs.innerHTML="",Xs.appendChild(ge.el),window.addEventListener("resize",()=>{ge.el.width=document.body.clientWidth,ge.el.height=document.body.clientHeight,sa(ge.el,Kn.cameraType)})};var k0=ta('<div style="position: absolute;left:0;top:0;z-index: 1;"></div>  <div style="position: absolute;left:5px;top:5px;z-index: 11;cursor: pointer;" class="pointer-events-auto" id="camera-toggle"><!></div> <!>',1);function H0(n,t){dr(t,!1);let e=Nr(t,"postMessage",8),i=Nr(t,"showMenu",8,!0);Xr();var r=k0(),s=sf(r);Mi(s,u=>Xs=u,()=>Xs);var a=In(s,2);a.__click=()=>{Kn.cameraType=v0(),console.log(Kn),sa(ge.el,Kn.cameraType)};var o=ln(a);M0(o);var c=In(a,2);{var l=u=>{U0(u,{Clickhandle:f=>{Kn.main=f,Yo(ge.el,Kn,e())}})};Cf(c,u=>{i()&&u(l)})}Wr(n,r),pr()}Jo(["click"]);const V0=async n=>{const t=new DecompressionStream("gzip"),e=t.writable.getWriter();e.write(n.buffer),e.close();const r=await new Response(t.readable).arrayBuffer();let s="";try{s=new TextDecoder().decode(r)}catch(a){console.error(a)}return s},G0=(n,t)=>{let e="",i=0;uh(n,/\/\*\*\s*([\w\.\/]+)\s*\*/g,(r,s)=>{e&&t({name:e,db:n.slice(i,r.index).trim()}),e=r[1],i=s+1}),e&&t({name:e,db:n.slice(i).trim()})};class W0 extends ul{constructor(t){super(t)}load(t,e,i,r){const s=this,a=new ip(this.manager);a.setPath(this.path),a.setResponseType("arraybuffer"),a.setRequestHeader(this.requestHeader),a.setWithCredentials(this.withCredentials),a.load(t,function(o){try{e(s.parse(o))}catch(c){r?r(c):console.error(c),s.manager.itemError(t)}},i,r)}parse(t){function e(l){const u=new DataView(l),f=32/8*3+32/8*3*3+16/8,d=u.getUint32(80,!0);if(80+32/8+d*f===u.byteLength)return!0;const _=[115,111,108,105,100];for(let v=0;v<5;v++)if(i(_,u,v))return!1;return!0}function i(l,u,f){for(let d=0,p=l.length;d<p;d++)if(l[d]!==u.getUint8(f+d))return!1;return!0}function r(l){const u=new DataView(l),f=u.getUint32(80,!0);let d,p,_,v=!1,m,h,y,b,E;for(let P=0;P<70;P++)u.getUint32(P,!1)==1129270351&&u.getUint8(P+4)==82&&u.getUint8(P+5)==61&&(v=!0,m=new Float32Array(f*3*3),h=u.getUint8(P+6)/255,y=u.getUint8(P+7)/255,b=u.getUint8(P+8)/255,E=u.getUint8(P+9)/255);const C=84,w=50,R=new tn,L=new Float32Array(f*3*3),S=new Float32Array(f*3*3),M=new zt;for(let P=0;P<f;P++){const O=C+P*w,H=u.getFloat32(O,!0),j=u.getFloat32(O+4,!0),X=u.getFloat32(O+8,!0);if(v){const G=u.getUint16(O+48,!0);(G&32768)===0?(d=(G&31)/31,p=(G>>5&31)/31,_=(G>>10&31)/31):(d=h,p=y,_=b)}for(let G=1;G<=3;G++){const K=O+G*12,k=P*3*3+(G-1)*3;L[k]=u.getFloat32(K,!0),L[k+1]=u.getFloat32(K+4,!0),L[k+2]=u.getFloat32(K+8,!0),S[k]=H,S[k+1]=j,S[k+2]=X,v&&(M.setRGB(d,p,_,Ve),m[k]=M.r,m[k+1]=M.g,m[k+2]=M.b)}}return R.setAttribute("position",new ve(L,3)),R.setAttribute("normal",new ve(S,3)),v&&(R.setAttribute("color",new ve(m,3)),R.hasColors=!0,R.alpha=E),R}function s(l){const u=new tn,f=/solid([\s\S]*?)endsolid/g,d=/facet([\s\S]*?)endfacet/g,p=/solid\s(.+)/;let _=0;const v=/[\s]+([+-]?(?:\d*)(?:\.\d*)?(?:[eE][+-]?\d+)?)/.source,m=new RegExp("vertex"+v+v+v,"g"),h=new RegExp("normal"+v+v+v,"g"),y=[],b=[],E=[],C=new I;let w,R=0,L=0,S=0;for(;(w=f.exec(l))!==null;){L=S;const M=w[0],P=(w=p.exec(M))!==null?w[1]:"";for(E.push(P);(w=d.exec(M))!==null;){let j=0,X=0;const G=w[0];for(;(w=h.exec(G))!==null;)C.x=parseFloat(w[1]),C.y=parseFloat(w[2]),C.z=parseFloat(w[3]),X++;for(;(w=m.exec(G))!==null;)y.push(parseFloat(w[1]),parseFloat(w[2]),parseFloat(w[3])),b.push(C.x,C.y,C.z),j++,S++;X!==1&&console.error("THREE.STLLoader: Something isn't right with the normal of face number "+_),j!==3&&console.error("THREE.STLLoader: Something isn't right with the vertices of face number "+_),_++}const O=L,H=S-L;u.userData.groupNames=E,u.addGroup(O,H,R),R++}return u.setAttribute("position",new Ge(y,3)),u.setAttribute("normal",new Ge(b,3)),u}function a(l){return typeof l!="string"?new TextDecoder().decode(l):l}function o(l){if(typeof l=="string"){const u=new Uint8Array(l.length);for(let f=0;f<l.length;f++)u[f]=l.charCodeAt(f)&255;return u.buffer||u}else return l}const c=o(t);return e(c)?r(c):s(a(t))}}function X0(n,t){dr(t,!1);let e=nf(!0);Df(()=>(z0(),zn.postMessage({type:"loaded"}),window.addEventListener("message",i=>{const r=i.data;r.gzData&&V0(r.gzData).then(s=>{G0(s,a=>{Hc(a),console.log(a.name)}),console.log(ge),Yo(ge.el,ge.workermsg,zn.postMessage)}),r.stlData?(console.log(r),_0(ge.el,new W0().parse(r.stlData)),dn(e,!1)):dn(e,!0),r.getSrc&&Hr(ge.workermsg.index,zn.postMessage).then(s=>{console.log(s),gl(s,(a,o)=>{zn.postMessage({type:"src",name:a,code:new TextEncoder().encode(o)})}).then(()=>{zn.postMessage({type:"src"})})}),r.del&&b0(r.del.name),r.init&&Hc(r.init,zn.postMessage),r.run&&(console.log("run",ge),Yo(ge.el,Object.assign({},ge.workermsg,{cameraType:r.open?ge.workermsg.cameraType:""}),zn.postMessage))}),()=>{})),Xr(),H0(n,{get postMessage(){return zn.postMessage},get showMenu(){return Ze(e)}}),pr()}bf(X0,{target:document.getElementById("app")});
