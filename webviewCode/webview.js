...
`}}}const xr=new jd,Ti=new Qi,Mr=new Qi,c0=new rp(16777147,16777147,.6);xr.add(c0);const Zr=new dl(16777215,1);Zr.position.set(5,10,7);Zr.castShadow=!0;Zr.shadow.mapSize.width=2048;Zr.shadow.mapSize.height=2048;Mr.add(Zr);const u0=new op(4210752,.3);Mr.add(u0);const sh=new dl(16777215,.3);sh.position.set(-5,5,-5);Mr.add(sh);const ah=new dl(16777215,.4);ah.position.set(0,5,-10);Mr.add(ah);const oh=new cp(20);Mr.add(oh);xr.background=null;const lh=new je(40,1,.1,2e3),h0=new fl(0,0,0,0,.1,2e3);let we=lh,Lr,Rr,pr;xr.add(Ti);xr.add(Mr);const Ho=n=>{let i=new _r().setFromObject(n).getSize(new I).length();return i||(i=Ho(oh)),i},f0=new l0,d0=()=>f0.parse(Ti,{binary:!0});function ra(n,t="Perspective"){if(Lr){if(t==="Orthographic"){const e=n.width/n.height,i=Ho(Ti)/2;we=h0,we.left=-i*e,we.right=i*e,we.top=i,we.bottom=-i,we.position.set(0,0,i),Vo(n)}else if(t==="Perspective"){we=lh;const e=Ho(Ti),i=we.fov*(Math.PI/180);we.position.z=e/2/Math.tan(i/2),we.aspect=n.width/n.height,Vo(n)}we.updateProjectionMatrix(),Lr.setSize(n.width,n.height),Lr.render(xr,we)}}const zc=()=>{requestAnimationFrame(()=>{Lr.render(xr,we)})},Vo=n=>{Rr?(Rr.object=we,Rr.removeEventListener("change",zc)):Rr=new Kv(we,n),Rr.addEventListener("change",zc)},_l=(n,t=!1)=>{Lr=new Yv({antialias:!0,alpha:!0,canvas:n,preserveDrawingBuffer:!0}),Vo(n)},p0=n=>{n!==pr?(pr=n,_l(n)):Ti.clear()},m0=new zo({color:30932,specular:1118481,shininess:200}),_0=(n,t)=>{n!==pr&&(pr=n,_l(n)),Ti.add(new un(t,m0)),ra(n)},g0=(n,...t)=>{n!==pr&&(pr=n,_l(n)),Ti.add(...t)};let Go,Wo,Xo,Ki=!0;function v0(){return Ki=!Ki,Go.setAttribute("opacity",Ki?"1":"0.5"),Wo.setAttribute("opacity",Ki?"0.5":"1"),Xo.setAttribute("x",Ki?"12":"24"),Ki?"Perspective":"Orthographic"}var x0=Tf('<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="1" width="46" height="46" rx="4" fill="#2d2d2d" stroke="#555" stroke-width="1"></rect><g id="perspective-icon" transform="translate(8, 8) scale(0.8)"><path d="M6 6 L26 6 L36 26 L16 26 Z" fill="none" stroke="#4fc3f7" stroke-width="2" stroke-linejoin="round"></path><path d="M6 6 L16 26" stroke="#4fc3f7" stroke-width="2"></path><path d="M26 6 L36 26" stroke="#4fc3f7" stroke-width="2"></path><circle cx="21" cy="1" r="3" fill="#4fc3f7"></circle><line x1="21" y1="4" x2="21" y2="6" stroke="#4fc3f7" stroke-width="2"></line></g><g id="orthographic-icon" transform="translate(8, 8) scale(0.8)" opacity="0.5"><rect x="6" y="6" width="30" height="20" fill="none" stroke="#81c784" stroke-width="2" stroke-linejoin="round"></rect><line x1="6" y1="6" x2="1" y2="1" stroke="#81c784" stroke-width="2"></line><line x1="36" y1="6" x2="41" y2="1" stroke="#81c784" stroke-width="2"></line><line x1="36" y1="26" x2="41" y2="31" stroke="#81c784" stroke-width="2"></line><line x1="6" y1="26" x2="1" y2="31" stroke="#81c784" stroke-width="2"></line></g><rect x="12" y="36" width="24" height="4" rx="2" fill="#555"></rect><rect id="toggle-indicator" x="12" y="36" width="12" height="4" rx="2" fill="#4fc3f7"></rect></svg>');function M0(n){var t=x0(),e=Un(on(t));xi(e,s=>Go=s,()=>Go);var i=Un(e);xi(i,s=>Wo=s,()=>Wo);var r=Un(i,2);xi(r,s=>Xo=s,()=>Xo),qr(n,t)}const ar=new Map,Ur=new Map,kc=window.includeImport,ch=(n,t,e)=>{let i;for(;(i=t.exec(n))!==null;)e(i,t.lastIndex)},S0=n=>{const t=/import\s*(?:(?:(?:\w+|\*\s*as\s*\w+|\{[^}]*\})\s+from\s+)?['"]([^'"]+)['"]|['"]([^'"]+)['"])/g,e=[];return ch(n,t,(i,r)=>{const s=i[1]||i[2],a=Math.max(i[0].indexOf("'"),i[0].indexOf('"')),o=i.index+a+1;e.push({moduleName:s,startPosition:o,endPosition:o+s.length})}),e},Vr=async(n,t,e=new Set)=>{let i="";if(e.add(n),!!n.srcList){for(const r of n.srcList){if(typeof r=="string"){i+=r;continue}const s=await r();s.db&&(e.has(s)||await Vr(s,t,e)),i+=s.name}i&&t(n.name,i)}},bi=(n,t)=>new Promise((e,i)=>{if(n.startsWith("./")||kc[n]&&(n=kc[n]),ar.has(n)){e(ar.get(n));return}if(!t){console.log("not reqmsg",n),e(qo({name:n}));return}t({type:"req",path:n});const r=setTimeout(()=>{Ur.delete(n),e(qo({name:n}))},2e3);Ur.set(n,s=>{clearTimeout(r),e(s),Ur.delete(n)})}),E0=new TextDecoder,uh=n=>{n.url&&(URL.revokeObjectURL(n.url),n.url="",n.persons.forEach(t=>{uh(t)}))},y0=(n,t,e)=>{if(uh(n),n.srcList=[],!t.db)return;let i="";if(typeof t.db=="string")i=t.db;else if(t.db instanceof ArrayBuffer)i=E0.decode(t.db);else{console.log(t,typeof t.db);return}let r=0;S0(i).forEach(s=>{n.srcList.push(i.slice(r,s.startPosition)),n.srcList.push(()=>bi(s.moduleName,e)),r=s.endPosition}),n.srcList.push(i.slice(r))},T0=async n=>{if(n.url)return n.url;if(!n.srcList)return n.name;let t="";for(const e of n.srcList)if(typeof e=="string")t+=e;else{const i=await e();t+=await i.getUri(),typeof i!="string"&&i.persons&&i.persons.add(n)}return t?(n.url=URL.createObjectURL(new Blob([t],{type:"application/javascript"})),n.url):n.name},qo=n=>{const t={persons:new Set,getUri:async()=>T0(t),...n};return t},b0=n=>{ar.delete(n)},hh=(n,t)=>{if(!n.name)return;let e;ar.has(n.name)?e=ar.get(n.name):(e=qo(n),ar.set(n.name,e)),y0(e,n,t),Ur.has(n.name)&&Ur.get(n.name)(e)};var A0=Qs('<details name="downMenu"><summary class="download-summary svelte-17o52b0"><svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M24 32L24 16M24 32L18 26M24 32L30 26" stroke="#3498db" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10 38H38" stroke="#3498db" stroke-width="3" stroke-linecap="round"></path></svg></summary>  <div class="download-options svelte-17o52b0"><div class="download-option svelte-17o52b0"><div class="option-text svelte-17o52b0">STL</div></div> <div class="download-option svelte-17o52b0"><div class="option-text svelte-17o52b0">Gzip</div></div></div></details>');function w0(n,t){Ri(t,!1);let e=lr(t,"workermsg",8);const i=()=>{const d=d0(),p=new Blob([d.buffer],{type:"application/octet-stream"}),_=document.createElement("a");_.href=URL.createObjectURL(p),_.download=`${e().name}_${e().main}_${e().index.split(".").shift()}_${Date.now()}.stl`,_.click(),URL.revokeObjectURL(_.href)},r=async()=>{if(!window.CompressionStream||!window.DecompressionStream){console.log("down code err");return}let d=e().index;d.startsWith("./")||(d="./"+d);const p=await bi("./lib/csgChange.js"),_=await bi(d);let v="";await Vr(p,(b,E)=>{v+=`
/**${b}*/
${E}
`}),await Vr(_,(b,E)=>{v+=`
/**${b}*/
${E}
`});const m=await s(v),h=new Blob(m,{type:"application/gzip"}),y=document.createElement("a");y.href=URL.createObjectURL(h),y.download=`${e().name}_${e().main}_${e().index.split(".").shift()}_${Date.now()}.mgtoy.gz`,y.click(),URL.revokeObjectURL(y.href)},s=async d=>{const p=new TextEncoder().encode(d),_=new ReadableStream({start(b){b.enqueue(p),b.close()}}),v=new CompressionStream("gzip"),h=_.pipeThrough(v).getReader(),y=[];for(;;){const{done:b,value:E}=await h.read();if(b)break;y.push(E)}return y};mr();var a=A0(),o=Un(on(a),2),c=on(o),l=on(c);l.__click=i;var u=Un(c,2),f=on(u);f.__click=r,qr(n,a),Ci()}Jo(["click"]);let Ir,Ws,Nr;const R0=n=>{Ir.innerHTML="",Nr.textContent=n.basename,console.log("change Main name",Nr),n.list.forEach(t=>{const e=Ws.cloneNode(!0);e.textContent=t,Ir.appendChild(e)}),Ir.appendChild(Ws)};var C0=n=>{console.log(n)},P0=Qs('<details name="moduleMenu"><summary style="cursor: pointer;height:48px;text-align: center;line-height: 48px;">...</summary>  <div style="color:white;text-align: center;" id="module_list"><button class="option-text" style="height:48:px;line-height:48px;cursor: pointer;">...</button></div></details>');function D0(n,t){Ri(t,!1);let e=lr(t,"Clickhandle",8);mr();var i=P0(),r=on(i);xi(r,o=>Nr=o,()=>Nr);var s=Un(r,2);s.__click=o=>{const c=o.target.closest("button");console.log(c.textContent),c.textContent!=="..."&&(Nr.textContent="...",e()(c.textContent))};var a=on(s);a.__click=[C0],xi(a,o=>Ws=o,()=>Ws),xi(s,o=>Ir=o,()=>Ir),qr(n,i),Ci()}Jo(["click"]);const jn={...window.myConfig,cameraType:"Perspective",module:n=>{R0(n)}};var L0=Qs('<div id="downMenuList"><div style="position: absolute;right:5px;top:5px;z-index: 11;cursor: pointer;" class="pointer-events-auto "><!></div> <div style="position:absolute;left:0px;top:5px;z-index:10;width:100%;font-weight: 500;" class="pointer-events-auto"><!></div></div>');function U0(n,t){Ri(t,!1);let e=lr(t,"Clickhandle",8);mr();var i=L0(),r=on(i),s=on(r);w0(s,{get workermsg(){return jn}});var a=Un(r,2),o=on(a);D0(o,{get Clickhandle(){return e()}}),qr(n,i),Ci()}const Hc=!1,Gr={mesh:{def:new zo({color:34001,flatShading:Hc}),make:n=>new zo({...n,flatShading:Hc})},line:{def:new Hs({color:255}),make:n=>new Hs(n)},lines:null};Gr.lines=Gr.line;Gr.instance=Gr.mesh;function I0(n,{smooth:t=!1}){const{vertices:e,indices:i,normals:r,color:s,colors:a,isTransparent:o=!1,opacity:c}=n;let{transforms:l}=n;const u=n.type||"mesh",f=Gr[u];if(!f){console.error(`material not found for type ${u}`,n);return}let d=f.def;if(s||a){const v=s||a,m={vertexColors:!!a,opacity:v[3]===void 0?1:v[3],transparent:s&&v[3]!==1&&v[3]!==void 0||o};c&&(m.opacity=c),a||(m.color=new zt(s[0],s[1],s[2])),d=f.make(m),c&&(d.transparent=!0,d.opacity=c)}let p=new Qe;p.setAttribute("position",new _e(e,3)),i&&p.setIndex(new _e(i,1)),r&&p.setAttribute("normal",new _e(r,3)),t&&(p=N0(p,Math.PI/10)),a&&p.setAttribute("color",new _e(a,o?4:3));let _;switch(u){case"mesh":_=new un(p,d);break;case"line":_=new Ku(p,d);break;case"lines":_=new Zu(p,d);break}return l&&_.applyMatrix4({elements:l}),_}function N0(n,t=Math.PI/3){const e=Math.cos(t),i=(1+1e-10)*100,r=[new I,new I,new I],s=new I,a=new I,o=new I,c=new I;function l(v){const m=~~(v.x*i),h=~~(v.y*i),y=~~(v.z*i);return`${m},${h},${y}`}const u=n.index?n.toNonIndexed():n,f=u.attributes.position,d={};for(let v=0,m=f.count/3;v<m;v++){const h=3*v,y=r[0].fromBufferAttribute(f,h+0),b=r[1].fromBufferAttribute(f,h+1),E=r[2].fromBufferAttribute(f,h+2);s.subVectors(E,b),a.subVectors(y,b);const C=new I().crossVectors(s,a).normalize();for(let w=0;w<3;w++){const R=r[w],L=l(R);L in d||(d[L]=[]),d[L].push(C)}}const p=new Float32Array(f.count*3),_=new _e(p,3,!1);for(let v=0,m=f.count/3;v<m;v++){const h=3*v,y=r[0].fromBufferAttribute(f,h+0),b=r[1].fromBufferAttribute(f,h+1),E=r[2].fromBufferAttribute(f,h+2);s.subVectors(E,b),a.subVectors(y,b),o.crossVectors(s,a).normalize();for(let C=0;C<3;C++){const w=r[C],R=l(w),L=d[R];c.set(0,0,0);for(let S=0,M=L.length;S<M;S++){const P=L[S];o.dot(P)>e&&c.add(P)}c.normalize(),_.setXYZ(h+C,c.x,c.y,c.z)}}return u.setAttribute("normal",_),u}const F0=`
...
};`;let An;const B0=async(n,t)=>{const i=await(await bi("./lib/csgChange.js",t)).getUri();let r=n.index;r.startsWith("./")||(r="./"+r);const a=await(await bi(r,t)).getUri(),o=`import * as csg  from '${i}'
