...
};`;let zn,ao,oo=0;const Vx=async(n,t)=>{const i=await(await Ni("./lib/csgChange.js",t)).getUri();let r=n.in;r.startsWith("./")||(r="./"+r),r.endsWith(".js")||(r+=".js");const a=await(await Ni(r,t)).getUri(),o=`import * as csg  from '${i}'
