...
1. 下载[solidjscad-0.0.2.vsix](https://github.com/sureboy/solidJSCADExt/releases/download/0.0.2/solidjscad-0.0.2.vsix)文件
...
或者，您也可以在终端中使用命令行安装 ：
        ...
        bash code --install-extension {yourPath}/solidjscad-0.0.2.vsix
