...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function gc(){return new ni({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:dl(),fragmentShader:`
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function vc(){return new ni({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:dl(),fragmentShader:`
...
`].filter(wr).join(`
`)),a=ko(a),a=Cc(a,e),a=Pc(a,e),o=ko(o),o=Cc(o,e),o=Pc(o,e),a=Dc(a),o=Dc(o),e.isRawShaderMaterial!==!0&&(y=`#version 300 es
